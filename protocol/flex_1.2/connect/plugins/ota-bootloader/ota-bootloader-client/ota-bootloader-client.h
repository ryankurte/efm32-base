#ifndef _OTA_BOOTLOADER_CLIENT_H_
#define _OTA_BOOTLOADER_CLIENT_H_
 ...
 *
 * See ota-bootloader-client.h for source code.
 * @{
 */
 ...
 * - ::EMBER_OTA_BOOTLOADER_STATUS_SUCCESS   If the ongoing image download
 * process was successfully aborted.
 * - ::EMBER_OTA_BOOTLOADER_STATUS_INVALID_CALL   If the client was not
 ...
 * image or ignore it. If the application chooses to receive the image, other
 ...
 * client will be allowing segments also from this alternate server. If this is
 * set to ::EMBER_BROADCAST_ADDRESS, the client shall accept segments with the
 ...
 * - ::EMBER_OTA_BOOTLOADER_STATUS_SUCCESS  indicating that the full image
 ...
 * callback.
 * - ::EMBER_OTA_BOOTLOADER_STATUS_FAILED  indicating that the client failed to
 * fully download the image and the download process was terminated.
 * - ::EMBER_OTA_BOOTLOADER_STATUS_TIMEOUT indicating that the client timed out
 * waiting for a message from the server.
 * - ::EMBER_OTA_BOOTLOADER_STATUS_ABORTED indicating that the application
 ...
 * application that shall be reported to the server.
 */
...
#endif // _OTA_BOOTLOADER_CLIENT_H_

...
#ifndef _OTA_BOOTLOADER_COMMON_INTERNAL_H_
#define _OTA_BOOTLOADER_COMMON_INTERNAL_H_

#if (defined(EMBER_AF_PLUGIN_OTA_BOOTLOADER_SERVER_SECURITY_ENABLED) \
  || defined(EMBER_AF_PLUGIN_OTA_BOOTLOADER_CLIENT_SECURITY_ENABLED))
...
#endif // _OTA_BOOTLOADER_COMMON_INTERNAL_H_

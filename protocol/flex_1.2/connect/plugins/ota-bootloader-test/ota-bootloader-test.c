...
#if defined(EMBER_AF_PLUGIN_OTA_BOOTLOADER_SERVER)
#include EMBER_AF_API_OTA_BOOTLOADER_SERVER
#endif // EMBER_AF_PLUGIN_OTA_BOOTLOADER_SERVER

#if defined(EMBER_AF_PLUGIN_OTA_BOOTLOADER_CLIENT)
#include EMBER_AF_API_OTA_BOOTLOADER_CLIENT
#endif // EMBER_AF_PLUGIN_OTA_BOOTLOADER_CLIENT
...
void emberAfPluginOtaBootloaderClientImageDownloadCompleteCallback(EmberAfOtaBootloaderStatus status,
                                                                   ...
                                                                   uint32_t imageSize)
{
  if (status == EMBER_OTA_BOOTLOADER_STATUS_SUCCESS) {

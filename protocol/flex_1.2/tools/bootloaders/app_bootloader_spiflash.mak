...
OUTPUT_DIR = $(BUILD_DIR)/bootloader-$(BOARD)/app-bootloader-spiflash
...
CDEFS = \
      ...
      -DBTL_HAS_SERIAL \
      -DBOOTLOADER \
      -DBOOTLOADER_TYPE=BL_EXT_TYPE_APP_SPI \
...
SOURCE_FILES = \
	     ...
	     $(GLOBAL_BASE_DIR)/hal/micro/cortexm3/common/app-bootloader-custom.c \
	     $(GLOBAL_BASE_DIR)/hal/micro/cortexm3/efm32/bootloader/app-bootloader-efm32.c \
	     ...
	     $(GLOBAL_BASE_DIR)/hal/micro/cortexm3/common/spiflash-class1.c \
	     $(GLOBAL_BASE_DIR)/hal/micro/cortexm3/efm32/bootloader/spiflash-low-level.c \
	     $(GLOBAL_DEVICE_DIR)/SiliconLabs/$(FAMILY)/Source/system_$(FAMILY).c \

LIB_FILES = \
	  $(BUILD_DIR)/app-bootloader-library-cortexm3-iarboot-$(FAMILY)-null/app-bootloader-library.a \

DEP_FILES = $(addprefix $(OUTPUT_DIR)/,$(subst ../,,$(CSOURCES:.c=.d)))

TARGET = app-bootloader-spiflash

/**************************************************************************//**
 * @file
 * @brief EFR32MG21 RTCC register and bit field definitions
 * @version 5.8.0
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFR32MG21_RTCC_H
#define EFR32MG21_RTCC_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32MG21_RTCC RTCC
 * @{
 * @brief EFR32MG21 RTCC Register Declaration.
 *****************************************************************************/
...
/** @} End of group EFR32MG21_RTCC */

/**************************************************************************//**
 * @addtogroup EFR32MG21_RTCC
 * @{
 * @defgroup EFR32MG21_RTCC_BitFields RTCC Bit Fields
 * @{
 *****************************************************************************/

/* Bit fields for RTCC IPVERSION */
#define _RTCC_IPVERSION_RESETVALUE              0x00000000UL                             /**< Default value for RTCC_IPVERSION            */
...
#define _RTCC_IPVERSION_IPVERSION_DEFAULT       0x00000000UL                             /**< Mode DEFAULT for RTCC_IPVERSION             */
...
#define _RTCC_IF_MASK                           0x0000001FUL                            /**< Mask for RTCC_IF                            */
...
#define RTCC_IF_CC0                             (0x1UL << 2)                            /**< CC Channel n Interrupt Flag                 */
#define _RTCC_IF_CC0_SHIFT                      2                                       /**< Shift value for RTCC_CC0                    */
#define _RTCC_IF_CC0_MASK                       0x4UL                                   /**< Bit mask for RTCC_CC0                       */
#define _RTCC_IF_CC0_DEFAULT                    0x00000000UL                            /**< Mode DEFAULT for RTCC_IF                    */
#define RTCC_IF_CC0_DEFAULT                     (_RTCC_IF_CC0_DEFAULT << 2)             /**< Shifted mode DEFAULT for RTCC_IF            */
#define RTCC_IF_CC1                             (0x1UL << 3)                            /**< CC Channel n Interrupt Flag                 */
#define _RTCC_IF_CC1_SHIFT                      3                                       /**< Shift value for RTCC_CC1                    */
#define _RTCC_IF_CC1_MASK                       0x8UL                                   /**< Bit mask for RTCC_CC1                       */
#define _RTCC_IF_CC1_DEFAULT                    0x00000000UL                            /**< Mode DEFAULT for RTCC_IF                    */
#define RTCC_IF_CC1_DEFAULT                     (_RTCC_IF_CC1_DEFAULT << 3)             /**< Shifted mode DEFAULT for RTCC_IF            */
#define RTCC_IF_CC2                             (0x1UL << 4)                            /**< CC Channel n Interrupt Flag                 */
#define _RTCC_IF_CC2_SHIFT                      4                                       /**< Shift value for RTCC_CC2                    */
#define _RTCC_IF_CC2_MASK                       0x10UL                                  /**< Bit mask for RTCC_CC2                       */
#define _RTCC_IF_CC2_DEFAULT                    0x00000000UL                            /**< Mode DEFAULT for RTCC_IF                    */
#define RTCC_IF_CC2_DEFAULT                     (_RTCC_IF_CC2_DEFAULT << 4)             /**< Shifted mode DEFAULT for RTCC_IF            */

/* Bit fields for RTCC IEN */
#define _RTCC_IEN_RESETVALUE                    0x00000000UL                            /**< Default value for RTCC_IEN                  */
#define _RTCC_IEN_MASK                          0x0000001FUL                            /**< Mask for RTCC_IEN                           */
...
#define RTCC_IEN_CC0                            (0x1UL << 2)                            /**< CC Channel n Interrupt Enable               */
#define _RTCC_IEN_CC0_SHIFT                     2                                       /**< Shift value for RTCC_CC0                    */
#define _RTCC_IEN_CC0_MASK                      0x4UL                                   /**< Bit mask for RTCC_CC0                       */
#define _RTCC_IEN_CC0_DEFAULT                   0x00000000UL                            /**< Mode DEFAULT for RTCC_IEN                   */
#define RTCC_IEN_CC0_DEFAULT                    (_RTCC_IEN_CC0_DEFAULT << 2)            /**< Shifted mode DEFAULT for RTCC_IEN           */
#define RTCC_IEN_CC1                            (0x1UL << 3)                            /**< CC Channel n Interrupt Enable               */
#define _RTCC_IEN_CC1_SHIFT                     3                                       /**< Shift value for RTCC_CC1                    */
#define _RTCC_IEN_CC1_MASK                      0x8UL                                   /**< Bit mask for RTCC_CC1                       */
#define _RTCC_IEN_CC1_DEFAULT                   0x00000000UL                            /**< Mode DEFAULT for RTCC_IEN                   */
#define RTCC_IEN_CC1_DEFAULT                    (_RTCC_IEN_CC1_DEFAULT << 3)            /**< Shifted mode DEFAULT for RTCC_IEN           */
#define RTCC_IEN_CC2                            (0x1UL << 4)                            /**< CC Channel n Interrupt Enable               */
#define _RTCC_IEN_CC2_SHIFT                     4                                       /**< Shift value for RTCC_CC2                    */
#define _RTCC_IEN_CC2_MASK                      0x10UL                                  /**< Bit mask for RTCC_CC2                       */
#define _RTCC_IEN_CC2_DEFAULT                   0x00000000UL                            /**< Mode DEFAULT for RTCC_IEN                   */
#define RTCC_IEN_CC2_DEFAULT                    (_RTCC_IEN_CC2_DEFAULT << 4)            /**< Shifted mode DEFAULT for RTCC_IEN           */
...
#define _RTCC_CC_CTRL_MASK                      0x0000007FUL                            /**< Mask for RTCC_CC_CTRL                       */
...
/** @} End of group EFR32MG21_RTCC_BitFields */
/** @} End of group EFR32MG21_RTCC */
/** @} End of group Parts */
#endif /* EFR32MG21_RTCC_H */

...
/******  EM34x Peripheral Interrupt Numbers ******************************************************/
  TIM1_IRQn             = 0,  /*!< 16+0  EM34x TIM1 Interrupt */
  TIM2_IRQn             = 1,  /*!< 16+1  EM34x TIM2 Interrupt */
  MGMT_IRQn             = 2,  /*!< 16+2  EM34x MGMT Interrupt */
  BB_IRQn               = 3,  /*!< 16+3  EM34x BB Interrupt */
  SLEEPTMR_IRQn         = 4,  /*!< 16+4  EM34x SLEEPTMR Interrupt */
  SC1_IRQn              = 5,  /*!< 16+5  EM34x SC1 Interrupt */
  SC2_IRQn              = 6,  /*!< 16+6  EM34x SC2 Interrupt */
  AESCCM_IRQn           = 7,  /*!< 16+7  EM34x AESCCM Interrupt */
  MACTMR_IRQn           = 8,  /*!< 16+8  EM34x MACTMR Interrupt */
  MACTX_IRQn            = 9,  /*!< 16+9  EM34x MACTX Interrupt */
  MACRX_IRQn            = 10, /*!< 16+10 EM34x MACRX Interrupt */
  ADC_IRQn              = 11, /*!< 16+11 EM34x ADC Interrupt */
  IRQA_IRQn             = 12, /*!< 16+12 EM34x IRQA Interrupt */
  IRQB_IRQn             = 13, /*!< 16+13 EM34x IRQB Interrupt */
  IRQC_IRQn             = 14, /*!< 16+14 EM34x IRQC Interrupt */
  IRQD_IRQn             = 15, /*!< 16+15 EM34x IRQD Interrupt */
  DEBUG_IRQn            = 16, /*!< 16+16 EM34x DEBUG Interrupt */
} IRQn_Type;

/**************************************************************************//**
 * @defgroup EM342_Core EM342 Core
 * @{
...
/** @} End of group EM342_Core */

/**************************************************************************//**
* @defgroup EM342_Part EM342 Part
* @{
******************************************************************************/

/** Part family */
#define _EM34x_FAMILY  1
...
#define PART_NUMBER          "EM342" /**< Part Number */

/** Memory map for EM342 */
...
#define MFB_SIZE_B          (0x00020000UL)
...
#define PORT_A_PIN_COUNT   3
#define PORT_A_PIN_MASK    0xB0 // 7   5 4
...
#include "system_em34x.h"  /* System Header */

/*@}*/ /* end of group EM342_Part */

/**************************************************************************//**
 * @defgroup EM342_Peripheral_TypeDefs EM342 Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/

#include "em34x_cmhv.h"
#include "em34x_baseband.h"
#include "em34x_mac.h"
#include "em34x_aesccm.h"
#include "em34x_cmlv.h"
#include "em34x_wdog.h"
#include "em34x_sleeptmr.h"
#include "em34x_calibrationadc.h"
#include "em34x_flashctrl.h"
#include "em34x_event_adc.h"
#include "em34x_event_bb.h"
#include "em34x_event_gpio.h"
#include "em34x_event_mac.h"
#include "em34x_event_mgmt.h"
#include "em34x_event_miss.h"
#include "em34x_event_nmi.h"
#include "em34x_event_sc12.h"
#include "em34x_event_aesccm.h"
#include "em34x_event_sleeptmr.h"
#include "em34x_event_tim.h"
#include "em34x_adc.h"
#include "em34x_gpio_p.h"
#include "em34x_gpio.h"
#include "em34x_sc.h"
#include "em34x_tim.h"

/*@}*/ /* end of group EM342_Peripheral_TypeDefs */

/**************************************************************************//**
 * @defgroup EM342_Peripheral_Base EM342 Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EM342_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EM342_Peripheral_Declaration  EM342 Peripheral Declarations
 * @{
 *****************************************************************************/
...
/** @} End of group EM342_Peripheral_Declaration */

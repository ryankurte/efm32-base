...
typedef struct
{
  ...
  uint32_t      RESERVED6[7];     /**< Reserved for future use **/
  ...
  uint32_t      RESERVED10[9];    /**< Reserved for future use **/
  ...
  uint32_t      RESERVED13[22];   /**< Reserved for future use **/
  ...
  uint32_t      RESERVED16[9];    /**< Reserved for future use **/

/**************************************************************************//**
 * @file efr32mg1b732f256gm32.h
 * @brief CMSIS Cortex-M Peripheral Access Layer Header File
 *        for EFR32MG1B732F256GM32
 * @version 5.2.1
 ******************************************************************************
 * # License
...
#ifndef EFR32MG1B732F256GM32_H
#define EFR32MG1B732F256GM32_H
...
/**************************************************************************//**
 * @defgroup EFR32MG1B732F256GM32 EFR32MG1B732F256GM32
 * @{
 *****************************************************************************/
...
/******  EFR32MG1B Peripheral Interrupt Numbers ********************************************/
...
/**************************************************************************//**
 * @defgroup EFR32MG1B732F256GM32_Core Core
 * @{
...
/** @} End of group EFR32MG1B732F256GM32_Core */

/**************************************************************************//**
* @defgroup EFR32MG1B732F256GM32_Part Part
* @{
******************************************************************************/
...
#if !defined(EFR32MG1B732F256GM32)
#define EFR32MG1B732F256GM32    1 /**< MIGHTY Gecko Part */
#endif

/** Configure part number */
#define PART_NUMBER               "EFR32MG1B732F256GM32" /**< Part Number */
...
/** Flash and SRAM limits for EFR32MG1B732F256GM32 */
...
#include "system_efr32mg1b.h"   /* System Header File */

/** @} End of group EFR32MG1B732F256GM32_Part */

/**************************************************************************//**
 * @defgroup EFR32MG1B732F256GM32_Peripheral_TypeDefs Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/

#include "efr32mg1b_msc.h"
#include "efr32mg1b_emu.h"
#include "efr32mg1b_rmu.h"
#include "efr32mg1b_cmu.h"
#include "efr32mg1b_crypto.h"
#include "efr32mg1b_gpio_p.h"
#include "efr32mg1b_gpio.h"
#include "efr32mg1b_prs_ch.h"
#include "efr32mg1b_prs.h"
#include "efr32mg1b_ldma_ch.h"
#include "efr32mg1b_ldma.h"
#include "efr32mg1b_fpueh.h"
#include "efr32mg1b_gpcrc.h"
#include "efr32mg1b_timer_cc.h"
#include "efr32mg1b_timer.h"
#include "efr32mg1b_usart.h"
#include "efr32mg1b_leuart.h"
#include "efr32mg1b_letimer.h"
#include "efr32mg1b_cryotimer.h"
#include "efr32mg1b_pcnt.h"
#include "efr32mg1b_i2c.h"
#include "efr32mg1b_adc.h"
#include "efr32mg1b_acmp.h"
#include "efr32mg1b_idac.h"
#include "efr32mg1b_rtcc_cc.h"
#include "efr32mg1b_rtcc_ret.h"
#include "efr32mg1b_rtcc.h"
#include "efr32mg1b_wdog_pch.h"
#include "efr32mg1b_wdog.h"
#include "efr32mg1b_dma_descriptor.h"
#include "efr32mg1b_devinfo.h"
#include "efr32mg1b_romtable.h"

/** @} End of group EFR32MG1B732F256GM32_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup EFR32MG1B732F256GM32_Peripheral_Base Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32MG1B732F256GM32_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EFR32MG1B732F256GM32_Peripheral_Declaration Peripheral Declarations
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32MG1B732F256GM32_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup EFR32MG1B732F256GM32_Peripheral_Offsets Peripheral Offsets
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32MG1B732F256GM32_Peripheral_Offsets */


/**************************************************************************//**
 * @defgroup EFR32MG1B732F256GM32_BitFields Bit Fields
 * @{
 *****************************************************************************/

#include "efr32mg1b_prs_signals.h"
#include "efr32mg1b_dmareq.h"

/**************************************************************************//**
 * @defgroup EFR32MG1B732F256GM32_UNLOCK Unlock Codes
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32MG1B732F256GM32_UNLOCK */

/** @} End of group EFR32MG1B732F256GM32_BitFields */

#include "efr32mg1b_af_ports.h"
#include "efr32mg1b_af_pins.h"
...
/** @} End of group EFR32MG1B732F256GM32 */

/**************************************************************************//**
 * @file efr32mg1v132f256gm48.h
 * @brief CMSIS Cortex-M Peripheral Access Layer Header File
 *        for EFR32MG1V132F256GM48
 * @version 5.2.1
 ******************************************************************************
 * # License
...
#ifndef EFR32MG1V132F256GM48_H
#define EFR32MG1V132F256GM48_H
...
/**************************************************************************//**
 * @defgroup EFR32MG1V132F256GM48 EFR32MG1V132F256GM48
 * @{
 *****************************************************************************/
...
/******  EFR32MG1V Peripheral Interrupt Numbers ********************************************/
...
/**************************************************************************//**
 * @defgroup EFR32MG1V132F256GM48_Core Core
 * @{
...
/** @} End of group EFR32MG1V132F256GM48_Core */

/**************************************************************************//**
* @defgroup EFR32MG1V132F256GM48_Part Part
* @{
******************************************************************************/
...
#if !defined(EFR32MG1V132F256GM48)
#define EFR32MG1V132F256GM48    1 /**< MIGHTY Gecko Part */
#endif

/** Configure part number */
#define PART_NUMBER               "EFR32MG1V132F256GM48" /**< Part Number */
...
/** Flash and SRAM limits for EFR32MG1V132F256GM48 */
...
#include "system_efr32mg1v.h"   /* System Header File */

/** @} End of group EFR32MG1V132F256GM48_Part */

/**************************************************************************//**
 * @defgroup EFR32MG1V132F256GM48_Peripheral_TypeDefs Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/

#include "efr32mg1v_msc.h"
#include "efr32mg1v_emu.h"
#include "efr32mg1v_rmu.h"
#include "efr32mg1v_cmu.h"
#include "efr32mg1v_crypto.h"
#include "efr32mg1v_gpio_p.h"
#include "efr32mg1v_gpio.h"
#include "efr32mg1v_prs_ch.h"
#include "efr32mg1v_prs.h"
#include "efr32mg1v_ldma_ch.h"
#include "efr32mg1v_ldma.h"
#include "efr32mg1v_fpueh.h"
#include "efr32mg1v_gpcrc.h"
#include "efr32mg1v_timer_cc.h"
#include "efr32mg1v_timer.h"
#include "efr32mg1v_usart.h"
#include "efr32mg1v_leuart.h"
#include "efr32mg1v_letimer.h"
#include "efr32mg1v_cryotimer.h"
#include "efr32mg1v_pcnt.h"
#include "efr32mg1v_i2c.h"
#include "efr32mg1v_adc.h"
#include "efr32mg1v_acmp.h"
#include "efr32mg1v_idac.h"
#include "efr32mg1v_rtcc_cc.h"
#include "efr32mg1v_rtcc_ret.h"
#include "efr32mg1v_rtcc.h"
#include "efr32mg1v_wdog_pch.h"
#include "efr32mg1v_wdog.h"
#include "efr32mg1v_dma_descriptor.h"
#include "efr32mg1v_devinfo.h"
#include "efr32mg1v_romtable.h"

/** @} End of group EFR32MG1V132F256GM48_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup EFR32MG1V132F256GM48_Peripheral_Base Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32MG1V132F256GM48_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EFR32MG1V132F256GM48_Peripheral_Declaration Peripheral Declarations
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32MG1V132F256GM48_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup EFR32MG1V132F256GM48_Peripheral_Offsets Peripheral Offsets
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32MG1V132F256GM48_Peripheral_Offsets */


/**************************************************************************//**
 * @defgroup EFR32MG1V132F256GM48_BitFields Bit Fields
 * @{
 *****************************************************************************/

#include "efr32mg1v_prs_signals.h"
#include "efr32mg1v_dmareq.h"

/**************************************************************************//**
 * @defgroup EFR32MG1V132F256GM48_UNLOCK Unlock Codes
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32MG1V132F256GM48_UNLOCK */

/** @} End of group EFR32MG1V132F256GM48_BitFields */

#include "efr32mg1v_af_ports.h"
#include "efr32mg1v_af_pins.h"
...
/** @} End of group EFR32MG1V132F256GM48 */

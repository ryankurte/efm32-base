...
/******  EM355x Peripheral Interrupt Numbers ******************************************************/
  TIM1_IRQn             = 0,  /*!< 16+0  EM355x TIM1 Interrupt */
  TIM2_IRQn             = 1,  /*!< 16+1  EM355x TIM2 Interrupt */
  MGMT_IRQn             = 2,  /*!< 16+2  EM355x MGMT Interrupt */
  BB_IRQn               = 3,  /*!< 16+3  EM355x BB Interrupt */
  SLEEPTMR_IRQn         = 4,  /*!< 16+4  EM355x SLEEPTMR Interrupt */
  SC1_IRQn              = 5,  /*!< 16+5  EM355x SC1 Interrupt */
  SC2_IRQn              = 6,  /*!< 16+6  EM355x SC2 Interrupt */
  AESCCM_IRQn           = 7,  /*!< 16+7  EM355x AESCCM Interrupt */
  MACTMR_IRQn           = 8,  /*!< 16+8  EM355x MACTMR Interrupt */
  MACTX_IRQn            = 9,  /*!< 16+9  EM355x MACTX Interrupt */
  MACRX_IRQn            = 10, /*!< 16+10 EM355x MACRX Interrupt */
  ADC_IRQn              = 11, /*!< 16+11 EM355x ADC Interrupt */
  IRQA_IRQn             = 12, /*!< 16+12 EM355x IRQA Interrupt */
  IRQB_IRQn             = 13, /*!< 16+13 EM355x IRQB Interrupt */
  IRQC_IRQn             = 14, /*!< 16+14 EM355x IRQC Interrupt */
  IRQD_IRQn             = 15, /*!< 16+15 EM355x IRQD Interrupt */
  DEBUG_IRQn            = 16, /*!< 16+16 EM355x DEBUG Interrupt */
} IRQn_Type;

/**************************************************************************//**
 * @defgroup EM3555_Core EM3555 Core
 * @{
...
/** @} End of group EM3555_Core */

/**************************************************************************//**
* @defgroup EM3555_Part EM3555 Part
* @{
******************************************************************************/

/** Part family */
#define _EM355x_FAMILY  1
...
#define PART_NUMBER          "EM3555" /**< Part Number */

/** Memory map for EM3555 */
#define RAM_BOTTOM          (0x20000000UL)
#define RAM_SIZE_B          (0x00008000UL)
...
#define PORT_B_PIN_COUNT   6
#define PORT_B_PIN_MASK    0x9F // 7     4 3 2 1 0
...
#include "system_em355x.h"  /* System Header */

/*@}*/ /* end of group EM3555_Part */

/**************************************************************************//**
 * @defgroup EM3555_Peripheral_TypeDefs EM3555 Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/

#include "em355x_cmhv.h"
#include "em355x_baseband.h"
#include "em355x_mac.h"
#include "em355x_aesccm.h"
#include "em355x_cmlv.h"
#include "em355x_wdog.h"
#include "em355x_sleeptmr.h"
#include "em355x_calibrationadc.h"
#include "em355x_flashctrl.h"
#include "em355x_event_adc.h"
#include "em355x_event_bb.h"
#include "em355x_event_gpio.h"
#include "em355x_event_mac.h"
#include "em355x_event_mgmt.h"
#include "em355x_event_miss.h"
#include "em355x_event_nmi.h"
#include "em355x_event_sc12.h"
#include "em355x_event_aesccm.h"
#include "em355x_event_sleeptmr.h"
#include "em355x_event_tim.h"

#include "em355x_adc.h"
#include "em355x_gpio_p.h"
#include "em355x_gpio.h"
#include "em355x_sc.h"
#include "em355x_tim.h"

/*@}*/ /* end of group EM3555_Peripheral_TypeDefs */

/**************************************************************************//**
 * @defgroup EM3555_Peripheral_Base EM3555 Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EM3555_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EM3555_Peripheral_Declaration  EM3555 Peripheral Declarations
 * @{
 *****************************************************************************/
...
/** @} End of group EM3555_Peripheral_Declaration */

/**************************************************************************//**
* @file
* @brief em355x_event_miss Register and Bit Field definitions
* @version 5.8.0
******************************************************************************
* @section License
...
#ifndef EM355X_EVENT_MISS_H
#define EM355X_EVENT_MISS_H

/**************************************************************************//**
 * @defgroup EM355X_EVENT_MISS
 * @{
 * @brief EM355X_EVENT_MISS Register Declaration
 *****************************************************************************/
...
/**************************************************************************//**
 * @defgroup EM355X_EVENT_MISS_BitFields
 * @{
 *****************************************************************************/

/* Bit fields for EVENT_MISS MISS */
#define _EVENT_MISS_MISS_RESETVALUE        0x00000000UL
#define _EVENT_MISS_MISS_MASK              0x000EFFFCUL
#define EVENT_MISS_MISS_USB                (0x1UL << 19)
#define _EVENT_MISS_MISS_USB_SHIFT         19
#define _EVENT_MISS_MISS_USB_MASK          0x80000UL
#define _EVENT_MISS_MISS_USB_DEFAULT       0x00000000UL
#define EVENT_MISS_MISS_USB_DEFAULT        (_EVENT_MISS_MISS_USB_DEFAULT << 19)
#define EVENT_MISS_MISS_SC4                (0x1UL << 18)
#define _EVENT_MISS_MISS_SC4_SHIFT         18
#define _EVENT_MISS_MISS_SC4_MASK          0x40000UL
#define _EVENT_MISS_MISS_SC4_DEFAULT       0x00000000UL
#define EVENT_MISS_MISS_SC4_DEFAULT        (_EVENT_MISS_MISS_SC4_DEFAULT << 18)
#define EVENT_MISS_MISS_SC3                (0x1UL << 17)
#define _EVENT_MISS_MISS_SC3_SHIFT         17
#define _EVENT_MISS_MISS_SC3_MASK          0x20000UL
#define _EVENT_MISS_MISS_SC3_DEFAULT       0x00000000UL
#define EVENT_MISS_MISS_SC3_DEFAULT        (_EVENT_MISS_MISS_SC3_DEFAULT << 17)
...
/** @} End of group EM355X_EVENT_MISS_BitFields */

#endif // EM355X_EVENT_MISS_H

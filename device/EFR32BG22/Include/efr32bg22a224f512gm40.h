 ...
 *
 *****************************************************************************/
#ifndef EFR32BG22A224F512GM40_H
#define EFR32BG22A224F512GM40_H
...
/**************************************************************************//**
 * @defgroup EFR32BG22A224F512GM40 EFR32BG22A224F512GM40
 * @{
 *****************************************************************************/
...
typedef enum IRQn{
  ...
  SYXO0_IRQn             = 44, /*!< 44 EFR32 SYXO0 Interrupt */
...
/**************************************************************************//**
 * @defgroup EFR32BG22A224F512GM40_Core EFR32BG22A224F512GM40 Core
 * @{
...
/** @} End of group EFR32BG22A224F512GM40_Core */

/**************************************************************************//**
* @defgroup EFR32BG22A224F512GM40_Part EFR32BG22A224F512GM40 Part
* @{
******************************************************************************/
...
#if !defined(EFR32BG22A224F512GM40)
#define EFR32BG22A224F512GM40    1 /**< FULL Part */
#endif

/** Configure part number */
#define PART_NUMBER                                "EFR32BG22A224F512GM40" /**< Part Number */
...
/** Flash and SRAM limits for EFR32BG22A224F512GM40 */
#define FLASH_BASE                                 (0x00000000UL)               /**< Flash Base Address */
#define FLASH_SIZE                                 (0x00080000UL)               /**< Available Flash Memory */
#define FLASH_PAGE_SIZE                            (1UL << MSC_MAIN_PSIZE_BITS) /**< Flash Memory page size */
...
#define DCI_PRESENT                                  /** DCI is available in this part */
#define DCI_COUNT                                  1 /** 1 DCIs available  */
...
#define ROOTCFG_PRESENT                              /** ROOTCFG is available in this part */
#define ROOTCFG_COUNT                              1 /** 1 ROOTCFGs available  */
...
/** @} End of group EFR32BG22A224F512GM40_Part */

/**************************************************************************//**
 * @defgroup EFR32BG22A224F512GM40_Peripheral_TypeDefs EFR32BG22A224F512GM40 Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/
#include "efr32bg22_emu.h"
#include "efr32bg22_cmu.h"
#include "efr32bg22_hfxo.h"
#include "efr32bg22_hfrco.h"
#include "efr32bg22_fsrco.h"
#include "efr32bg22_dpll.h"
#include "efr32bg22_lfxo.h"
#include "efr32bg22_lfrco.h"
#include "efr32bg22_ulfrco.h"
#include "efr32bg22_msc.h"
#include "efr32bg22_icache.h"
#include "efr32bg22_prs.h"
#include "efr32bg22_gpio.h"
#include "efr32bg22_ldma.h"
#include "efr32bg22_ldmaxbar.h"
#include "efr32bg22_timer.h"
#include "efr32bg22_usart.h"
#include "efr32bg22_burtc.h"
#include "efr32bg22_i2c.h"
#include "efr32bg22_syscfg.h"
#include "efr32bg22_buram.h"
#include "efr32bg22_gpcrc.h"
#include "efr32bg22_dci.h"
#include "efr32bg22_rootcfg.h"
#include "efr32bg22_dcdc.h"
#include "efr32bg22_pdm.h"
#include "efr32bg22_rfsense.h"
#include "efr32bg22_aes.h"
#include "efr32bg22_smu.h"
#include "efr32bg22_rtcc.h"
...
#include "efr32bg22_frc.h"
#include "efr32bg22_agc.h"
#include "efr32bg22_rfcrc.h"
#include "efr32bg22_modem.h"
#include "efr32bg22_synth.h"
#include "efr32bg22_protimer.h"
#include "efr32bg22_rac.h"
#include "efr32bg22_mailbox.h"
#include "efr32bg22_bufc.h"
#include "efr32bg22_devinfo.h"

/* Custom headers for LDMAXBAR and PRS mappings*/
#include "efr32bg22_prs_signals.h"
#include "efr32bg22_dma_descriptor.h"
#include "efr32bg22_ldmaxbar_defines.h"

/** @} End of group EFR32BG22A224F512GM40_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup EFR32BG22A224F512GM40_Peripheral_Base EFR32BG22A224F512GM40 Peripheral Memory Map
 * @{
 *****************************************************************************/
...
#define DCI_MESSAGING_BASE           (0x4008C000UL) /* DCI_MESSAGING base address */
#define ROOTCFG_BASE                 (0x40090000UL) /* ROOTCFG base address */
...
#define DCI_NS_MESSAGING_BASE        (0x5008C000UL) /* DCI_NS_MESSAGING base address */
#define ROOTCFG_NS_BASE              (0x50090000UL) /* ROOTCFG_NS base address */
...
/** @} End of group EFR32BG22A224F512GM40_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EFR32BG22A224F512GM40_Peripheral_Declaration EFR32BG22A224F512GM40 Peripheral Declarations Map
 * @{
 *****************************************************************************/
...
#define DCI_S_MESSAGING         ((DCI_MESSAGING_TypeDef *) DCI_MESSAGING_BASE)            /**< DCI_S_MESSAGING base pointer */
#define DCI_MESSAGING           ((DCI_MESSAGING_TypeDef *) DCI_MESSAGING_BASE)            /**< DCI_S_MESSAGING base pointer */
#define ROOTCFG_S               ((ROOTCFG_TypeDef *) ROOTCFG_BASE)                        /**< ROOTCFG_S base pointer */
#define ROOTCFG                 ((ROOTCFG_TypeDef *) ROOTCFG_BASE)                        /**< ROOTCFG_S base pointer */
...
#define DCI_NS_MESSAGING        ((DCI_MESSAGING_TypeDef *) DCI_NS_MESSAGING_BASE)         /**< DCI_NS_MESSAGING base pointer */
#define ROOTCFG_NS              ((ROOTCFG_TypeDef *) ROOTCFG_NS_BASE)                     /**< ROOTCFG_NS base pointer */
...
/** @} End of group EFR32BG22A224F512GM40_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup EFR32BG22A224F512GM40_Peripheral_Parameters EFR32BG22A224F512GM40 Peripheral Parameters
 * @{
...
#define DCI_NUM_GRANT                           0x10UL    /**> Number of grant bits */
...
/** @} End of group EFR32BG22A224F512GM40_Peripheral_Parameters  */

/** @} End of group EFR32BG22A224F512GM40 */
/** @}} End of group Parts */

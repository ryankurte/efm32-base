/**************************************************************************//**
* @file
* @brief em358x_adc Register and Bit Field definitions
* @version 5.8.0
******************************************************************************
* @section License
 ...
 * @defgroup EM358X_ADC
 * @{
 * @brief EM358X_ADC Register Declaration
 *****************************************************************************/
...
#define _ADC_DMASIZE_MASK               0x00007FFFUL
#define _ADC_DMASIZE_DMASIZE_SHIFT      0
#define _ADC_DMASIZE_DMASIZE_MASK       0x7FFFUL
...
#define _ADC_DMACUR_DMACURFIXED_SHIFT      16
#define _ADC_DMACUR_DMACURFIXED_MASK       0xFFFF0000UL
#define _ADC_DMACUR_DMACURFIXED_DEFAULT    0x00002000UL
#define ADC_DMACUR_DMACURFIXED_DEFAULT     (_ADC_DMACUR_DMACURFIXED_DEFAULT << 16)
#define _ADC_DMACUR_DMACUR_SHIFT           0
#define _ADC_DMACUR_DMACUR_MASK            0xFFFFUL

...
/******  EM358x Peripheral Interrupt Numbers ******************************************************/
  TIM1_IRQn             = 0,  /*!< 16+0  EM358x TIM1 Interrupt */
  TIM2_IRQn             = 1,  /*!< 16+1  EM358x TIM2 Interrupt */
  MGMT_IRQn             = 2,  /*!< 16+2  EM358x MGMT Interrupt */
  BB_IRQn               = 3,  /*!< 16+3  EM358x BB Interrupt */
  SLEEPTMR_IRQn         = 4,  /*!< 16+4  EM358x SLEEPTMR Interrupt */
  SC1_IRQn              = 5,  /*!< 16+5  EM358x SC1 Interrupt */
  SC2_IRQn              = 6,  /*!< 16+6  EM358x SC2 Interrupt */
  AESCCM_IRQn           = 7,  /*!< 16+7  EM358x AESCCM Interrupt */
  MACTMR_IRQn           = 8,  /*!< 16+8  EM358x MACTMR Interrupt */
  MACTX_IRQn            = 9,  /*!< 16+9  EM358x MACTX Interrupt */
  MACRX_IRQn            = 10, /*!< 16+10 EM358x MACRX Interrupt */
  ADC_IRQn              = 11, /*!< 16+11 EM358x ADC Interrupt */
  IRQA_IRQn             = 12, /*!< 16+12 EM358x IRQA Interrupt */
  IRQB_IRQn             = 13, /*!< 16+13 EM358x IRQB Interrupt */
...
/**************************************************************************//**
 * @defgroup EM3582_Core EM3582 Core
 * @{
...
/** @} End of group EM3582_Core */

/**************************************************************************//**
* @defgroup EM3582_Part EM3582 Part
* @{
******************************************************************************/

/** Part family */
#define _EM358x_FAMILY  1
...
#define PART_NUMBER          "EM3582" /**< Part Number */

/** Memory map for EM3582 */
...
#define MFB_SIZE_B          (0x00040000UL)
...
#include "system_em358x.h"  /* System Header */

/*@}*/ /* end of group EM3582_Part */

/**************************************************************************//**
 * @defgroup EM3582_Peripheral_TypeDefs EM3582 Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/

#include "em358x_cmhv.h"
#include "em358x_baseband.h"
#include "em358x_mac.h"
#include "em358x_aesccm.h"
#include "em358x_cmlv.h"
#include "em358x_wdog.h"
#include "em358x_sleeptmr.h"
#include "em358x_calibrationadc.h"
#include "em358x_flashctrl.h"
#include "em358x_event_adc.h"
#include "em358x_event_bb.h"
#include "em358x_event_gpio.h"
#include "em358x_event_mac.h"
#include "em358x_event_mgmt.h"
#include "em358x_event_miss.h"
#include "em358x_event_nmi.h"
#include "em358x_event_sc12.h"
#include "em358x_event_aesccm.h"
#include "em358x_event_sleeptmr.h"
#include "em358x_event_tim.h"
#include "em358x_event_usb.h"
#include "em358x_adc.h"
#include "em358x_gpio_p.h"
#include "em358x_gpio.h"
#include "em358x_sc.h"
#include "em358x_tim.h"
#include "em358x_usb.h"

/*@}*/ /* end of group EM3582_Peripheral_TypeDefs */

/**************************************************************************//**
 * @defgroup EM3582_Peripheral_Base EM3582 Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EM3582_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EM3582_Peripheral_Declaration  EM3582 Peripheral Declarations
 * @{
 *****************************************************************************/
...
/** @} End of group EM3582_Peripheral_Declaration */

...
/******  SKY66107 Peripheral Interrupt Numbers ******************************************************/
  TIM1_IRQn             = 0,  /*!< 16+0  SKY66107 TIM1 Interrupt */
  TIM2_IRQn             = 1,  /*!< 16+1  SKY66107 TIM2 Interrupt */
  MGMT_IRQn             = 2,  /*!< 16+2  SKY66107 MGMT Interrupt */
  BB_IRQn               = 3,  /*!< 16+3  SKY66107 BB Interrupt */
  SLEEPTMR_IRQn         = 4,  /*!< 16+4  SKY66107 SLEEPTMR Interrupt */
  SC1_IRQn              = 5,  /*!< 16+5  SKY66107 SC1 Interrupt */
  SC2_IRQn              = 6,  /*!< 16+6  SKY66107 SC2 Interrupt */
  AESCCM_IRQn           = 7,  /*!< 16+7  SKY66107 AESCCM Interrupt */
  MACTMR_IRQn           = 8,  /*!< 16+8  SKY66107 MACTMR Interrupt */
  MACTX_IRQn            = 9,  /*!< 16+9  SKY66107 MACTX Interrupt */
  MACRX_IRQn            = 10, /*!< 16+10 SKY66107 MACRX Interrupt */
  ADC_IRQn              = 11, /*!< 16+11 SKY66107 ADC Interrupt */
  IRQA_IRQn             = 12, /*!< 16+12 SKY66107 IRQA Interrupt */
  IRQB_IRQn             = 13, /*!< 16+13 SKY66107 IRQB Interrupt */
  IRQC_IRQn             = 14, /*!< 16+14 SKY66107 IRQC Interrupt */
  IRQD_IRQn             = 15, /*!< 16+15 SKY66107 IRQD Interrupt */
  DEBUG_IRQn            = 16, /*!< 16+16 SKY66107 DEBUG Interrupt */
  SC3_IRQn              = 17, /*!< 16+17 SKY66107 SC3 Interrupt */
  SC4_IRQn              = 18, /*!< 16+18 SKY66107 SC4 Interrupt */
  USB_IRQn              = 19, /*!< 16+19 SKY66107 USB Interrupt */
} IRQn_Type;

/**************************************************************************//**
 * @defgroup SKY66107_Core SKY66107 Core
 * @{
...
/** @} End of group SKY66107_Core */

/**************************************************************************//**
* @defgroup SKY66107_Part SKY66107 Part
* @{
******************************************************************************/

/** Part family */
#define _SKY66107_FAMILY  1
...
#define PART_NUMBER          "SKY66107" /**< Part Number */

/** Memory map for SKY66107 */
...
#define PORT_D_PIN_COUNT   8
#define PORT_D_PIN_MASK    0xFF // 7 6 5 4 3 2 1 0
...
#include "system_sky66107.h"  /* System Header */

/*@}*/ /* end of group SKY66107_Part */

/**************************************************************************//**
 * @defgroup SKY66107_Peripheral_TypeDefs SKY66107 Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/

#include "sky66107_cmhv.h"
#include "sky66107_baseband.h"
#include "sky66107_mac.h"
#include "sky66107_aesccm.h"
#include "sky66107_cmlv.h"
#include "sky66107_wdog.h"
#include "sky66107_sleeptmr.h"
#include "sky66107_calibrationadc.h"
#include "sky66107_flashctrl.h"
#include "sky66107_event_adc.h"
#include "sky66107_event_bb.h"
#include "sky66107_event_gpio.h"
#include "sky66107_event_mac.h"
#include "sky66107_event_mgmt.h"
#include "sky66107_event_miss.h"
#include "sky66107_event_nmi.h"
#include "sky66107_event_sc12.h"
#include "sky66107_event_sc34.h"
#include "sky66107_event_aesccm.h"
#include "sky66107_event_sleeptmr.h"
#include "sky66107_event_tim.h"
#include "sky66107_event_usb.h"
#include "sky66107_adc.h"
#include "sky66107_gpio_p.h"
#include "sky66107_gpio.h"
#include "sky66107_sc.h"
#include "sky66107_tim.h"
#include "sky66107_usb.h"

/*@}*/ /* end of group SKY66107_Peripheral_TypeDefs */

/**************************************************************************//**
 * @defgroup SKY66107_Peripheral_Base SKY66107 Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group SKY66107_Peripheral_Base */

/**************************************************************************//**
 * @defgroup SKY66107_Peripheral_Declaration  SKY66107 Peripheral Declarations
 * @{
 *****************************************************************************/
...
/** @} End of group SKY66107_Peripheral_Declaration */

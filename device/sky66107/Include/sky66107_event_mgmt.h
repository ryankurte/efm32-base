/**************************************************************************//**
* @file
* @brief sky66107_event_mgmt Register and Bit Field definitions
* @version 5.8.0
******************************************************************************
* @section License
...
#ifndef SKY66107_EVENT_MGMT_H
#define SKY66107_EVENT_MGMT_H

/**************************************************************************//**
 * @defgroup SKY66107_EVENT_MGMT
 * @{
 * @brief SKY66107_EVENT_MGMT Register Declaration
 *****************************************************************************/
...
/**************************************************************************//**
 * @defgroup SKY66107_EVENT_MGMT_BitFields
 * @{
 *****************************************************************************/

/* Bit fields for EVENT_MGMT FLAG */
#define _EVENT_MGMT_FLAG_RESETVALUE          0x00000000UL
#define _EVENT_MGMT_FLAG_MASK                0x0000000FUL
...
#define _EVENT_MGMT_CFG_MASK                0x0000000FUL
...
/** @} End of group SKY66107_EVENT_MGMT_BitFields */

#endif // SKY66107_EVENT_MGMT_H

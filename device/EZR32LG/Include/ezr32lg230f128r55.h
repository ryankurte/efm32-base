/**************************************************************************//**
 * @file ezr32lg230f128r55.h
 * @brief CMSIS Cortex-M Peripheral Access Layer Header File
 *        for EZR32LG230F128R55
 * @version 5.2.1
 ******************************************************************************
 * # License
...
#ifndef EZR32LG230F128R55_H
#define EZR32LG230F128R55_H
...
/**************************************************************************//**
 * @defgroup EZR32LG230F128R55 EZR32LG230F128R55
 * @{
 *****************************************************************************/
...
/**************************************************************************//**
 * @defgroup EZR32LG230F128R55_Core EZR32LG230F128R55 Core
 * @{
...
/** @} End of group EZR32LG230F128R55_Core */

/**************************************************************************//**
* @defgroup EZR32LG230F128R55_Part EZR32LG230F128R55 Part
* @{
******************************************************************************/
...
#if !defined(EZR32LG230F128R55)
#define EZR32LG230F128R55    1 /**< EZR Leopard Gecko Part  */
#endif

/** Configure part number */
#define PART_NUMBER          "EZR32LG230F128R55" /**< Part Number */
...
/** Flash and SRAM limits for EZR32LG230F128R55 */
...
/**************************************************************************//**
 * @defgroup EZR32LG230F128R55_RF_Interface EZR32LG230F128R55 RF_Interface
...
/** @} End of group EZR32LG230F128R55_RF_Interface */

#include "core_cm3.h"       /* Cortex-M3 processor and core peripherals */
#include "system_ezr32lg.h" /* System Header */

/** @} End of group EZR32LG230F128R55_Part */

/**************************************************************************//**
 * @defgroup EZR32LG230F128R55_Peripheral_TypeDefs EZR32LG230F128R55 Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/

#include "ezr32lg_dma_ch.h"
#include "ezr32lg_dma.h"
#include "ezr32lg_aes.h"
#include "ezr32lg_msc.h"
#include "ezr32lg_emu.h"
#include "ezr32lg_rmu.h"

/**************************************************************************//**
 * @defgroup EZR32LG230F128R55_CMU EZR32LG230F128R55 CMU
 * @{
 * @brief EZR32LG230F128R55_CMU Register Declaration
 *****************************************************************************/
typedef struct
{
...
#include "ezr32lg_lesense_ch.h"
#include "ezr32lg_lesense.h"
#include "ezr32lg_usart.h"
#include "ezr32lg_timer_cc.h"
#include "ezr32lg_timer.h"
#include "ezr32lg_acmp.h"
#include "ezr32lg_leuart.h"
#include "ezr32lg_rtc.h"
#include "ezr32lg_letimer.h"
#include "ezr32lg_pcnt.h"
#include "ezr32lg_i2c.h"
#include "ezr32lg_gpio_p.h"
#include "ezr32lg_gpio.h"
#include "ezr32lg_vcmp.h"
#include "ezr32lg_prs_ch.h"

/**************************************************************************//**
 * @defgroup EZR32LG230F128R55_PRS EZR32LG230F128R55 PRS
 * @{
 * @brief EZR32LG230F128R55_PRS Register Declaration
 *****************************************************************************/
typedef struct
{
...
#include "ezr32lg_burtc_ret.h"
#include "ezr32lg_burtc.h"
#include "ezr32lg_wdog.h"
#include "ezr32lg_etm.h"
#include "ezr32lg_dma_descriptor.h"
#include "ezr32lg_devinfo.h"
#include "ezr32lg_romtable.h"
#include "ezr32lg_calibrate.h"

/** @} End of group EZR32LG230F128R55_Peripheral_TypeDefs */

/**************************************************************************//**
 * @defgroup EZR32LG230F128R55_Peripheral_Base EZR32LG230F128R55 Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EZR32LG230F128R55_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EZR32LG230F128R55_Peripheral_Declaration  EZR32LG230F128R55 Peripheral Declarations
 * @{
 *****************************************************************************/
...
/** @} End of group EZR32LG230F128R55_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup EZR32LG230F128R55_BitFields EZR32LG230F128R55 Bit Fields
 * @{
 *****************************************************************************/

/**************************************************************************//**
 * @addtogroup EZR32LG230F128R55_PRS_Signals
 * @{
...
#define PRS_USARTRF0_IRTX        ((16 << 16) + 0) /**< PRS USART 0 IRDA out */
#define PRS_USARTRF0_TXC         ((16 << 16) + 1) /**< PRS USART 0 TX complete */
#define PRS_USARTRF0_RXDATAV     ((16 << 16) + 2) /**< PRS USART 0 RX Data Valid */
...
/** @} End of group EZR32LG230F128R55_PRS */

#include "ezr32lg_dmareq.h"
#include "ezr32lg_dmactrl.h"
#include "ezr32lg_usartrf.h"
#include "ezr32lg_uart.h"

/**************************************************************************//**
 * @defgroup EZR32LG230F128R55_CMU_BitFields  EZR32LG230F128R55_CMU Bit Fields
 * @{
 *****************************************************************************/
...
#define CMU_HFPERCLKEN0_USARTRF0                    (0x1UL << 0)                             /**< Universal Synchronous/Asynchronous Receiver/Transmitter 0 Clock Enable */
#define _CMU_HFPERCLKEN0_USARTRF0_SHIFT             0                                        /**< Shift value for CMU_USARTRF0 */
#define _CMU_HFPERCLKEN0_USARTRF0_MASK              0x1UL                                    /**< Bit mask for CMU_USARTRF0 */
#define _CMU_HFPERCLKEN0_USARTRF0_DEFAULT           0x00000000UL                             /**< Mode DEFAULT for CMU_HFPERCLKEN0 */
#define CMU_HFPERCLKEN0_USARTRF0_DEFAULT            (_CMU_HFPERCLKEN0_USARTRF0_DEFAULT << 0) /**< Shifted mode DEFAULT for CMU_HFPERCLKEN0 */
...
/** @} End of group EZR32LG230F128R55_CMU */



/**************************************************************************//**
 * @defgroup EZR32LG230F128R55_PRS_BitFields  EZR32LG230F128R55_PRS Bit Fields
 * @{
 *****************************************************************************/
...
#define _PRS_CH_CTRL_SIGSEL_USARTRF0IRTX        0x00000000UL                                /**< Mode USARTRF0IRTX for PRS_CH_CTRL */
...
#define _PRS_CH_CTRL_SIGSEL_USARTRF0TXC         0x00000001UL                                /**< Mode USARTRF0TXC for PRS_CH_CTRL */
...
#define _PRS_CH_CTRL_SIGSEL_USARTRF0RXDATAV     0x00000002UL                                /**< Mode USARTRF0RXDATAV for PRS_CH_CTRL */
...
#define PRS_CH_CTRL_SIGSEL_USARTRF0IRTX         (_PRS_CH_CTRL_SIGSEL_USARTRF0IRTX << 0)     /**< Shifted mode USARTRF0IRTX for PRS_CH_CTRL */
...
#define PRS_CH_CTRL_SIGSEL_USARTRF0TXC          (_PRS_CH_CTRL_SIGSEL_USARTRF0TXC << 0)      /**< Shifted mode USARTRF0TXC for PRS_CH_CTRL */
...
#define PRS_CH_CTRL_SIGSEL_USARTRF0RXDATAV      (_PRS_CH_CTRL_SIGSEL_USARTRF0RXDATAV << 0)  /**< Shifted mode USARTRF0RXDATAV for PRS_CH_CTRL */
...
#define _PRS_CH_CTRL_SOURCESEL_USARTRF0         0x00000010UL                                /**< Mode USARTRF0 for PRS_CH_CTRL */
...
#define PRS_CH_CTRL_SOURCESEL_USARTRF0          (_PRS_CH_CTRL_SOURCESEL_USARTRF0 << 16)     /**< Shifted mode USARTRF0 for PRS_CH_CTRL */
...
/**************************************************************************//**
 * @defgroup EZR32LG230F128R55_UNLOCK EZR32LG230F128R55 Unlock Codes
 * @{
 *****************************************************************************/
...
/** @} End of group EZR32LG230F128R55_UNLOCK */

/** @} End of group EZR32LG230F128R55_BitFields */

/**************************************************************************//**
 * @defgroup EZR32LG230F128R55_Alternate_Function EZR32LG230F128R55 Alternate Function
 * @{
 *****************************************************************************/

#include "ezr32lg_af_ports.h"
#include "ezr32lg_af_pins.h"

/** @} End of group EZR32LG230F128R55_Alternate_Function */
...
/** @} End of group EZR32LG230F128R55 */

/***************************************************************************//**
 * @file
 * @brief EFM32TG11B_SMU register and bit field definitions
 * @version 5.8.0
 *******************************************************************************
 * # License
 ...
 ******************************************************************************/
/***************************************************************************//**
 * @defgroup EFM32TG11B_SMU SMU
 * @{
 * @brief EFM32TG11B_SMU Register Declaration
 ******************************************************************************/
...
/***************************************************************************//**
 * @addtogroup EFM32TG11B_SMU
 * @{
 * @defgroup EFM32TG11B_SMU_BitFields SMU Bit Fields
 * @{
 ******************************************************************************/
...
#define SMU_PPUPATD0_LCD                   (0x1UL << 16)                          /**< Liquid Crystal Display Controller access control bit */
#define _SMU_PPUPATD0_LCD_SHIFT            16                                     /**< Shift value for SMU_LCD */
#define _SMU_PPUPATD0_LCD_MASK             0x10000UL                              /**< Bit mask for SMU_LCD */
#define _SMU_PPUPATD0_LCD_DEFAULT          0x00000000UL                           /**< Mode DEFAULT for SMU_PPUPATD0 */
#define SMU_PPUPATD0_LCD_DEFAULT           (_SMU_PPUPATD0_LCD_DEFAULT << 16)      /**< Shifted mode DEFAULT for SMU_PPUPATD0 */
...
#define _SMU_PPUFS_PERIPHID_LCD            0x00000010UL                         /**< Mode LCD for SMU_PPUFS */

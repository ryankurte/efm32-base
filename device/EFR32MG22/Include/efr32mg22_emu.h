/**************************************************************************//**
 * @file
 * @brief EFR32MG22 EMU register and bit field definitions
 * @version 5.8.0
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFR32MG22_EMU_H
#define EFR32MG22_EMU_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32MG22_EMU EMU
 * @{
 * @brief EFR32MG22 EMU Register Declaration.
 *****************************************************************************/
...
typedef struct {
  ...
  __IOM uint32_t PFMBYPCTRL;                    /**< PFM Bypass Control Register                        */
  ...
  __IOM uint32_t VSBTEMPCOMP;                   /**< RAM VSB Temperature Compensation                   */
  ...
  __IOM uint32_t PFMBYPCTRL_SET;                /**< PFM Bypass Control Register                        */
  ...
  uint32_t       RESERVED19[10U];               /**< Reserved for future use                      */
  __IOM uint32_t VSBTEMPCOMP_SET;               /**< RAM VSB Temperature Compensation                   */
  ...
  __IOM uint32_t PFMBYPCTRL_CLR;                /**< PFM Bypass Control Register                        */
  ...
  uint32_t       RESERVED30[10U];               /**< Reserved for future use                      */
  __IOM uint32_t VSBTEMPCOMP_CLR;               /**< RAM VSB Temperature Compensation                   */
  ...
  __IOM uint32_t PFMBYPCTRL_TGL;                /**< PFM Bypass Control Register                        */
  ...
  uint32_t       RESERVED41[10U];               /**< Reserved for future use                      */
  __IOM uint32_t VSBTEMPCOMP_TGL;               /**< RAM VSB Temperature Compensation                   */
...
/** @} End of group EFR32MG22_EMU */

/**************************************************************************//**
 * @addtogroup EFR32MG22_EMU
 * @{
 * @defgroup EFR32MG22_EMU_BitFields EMU Bit Fields
 * @{
 *****************************************************************************/
...
/* Bit fields for EMU PFMBYPCTRL */
#define _EMU_PFMBYPCTRL_RESETVALUE                0x00000006UL                               /**< Default value for EMU_PFMBYPCTRL            */
#define _EMU_PFMBYPCTRL_MASK                      0x00000007UL                               /**< Mask for EMU_PFMBYPCTRL                     */
#define EMU_PFMBYPCTRL_VREGINCMPEN                (0x1UL << 0)                               /**< VREGIN comparator enable                    */
#define _EMU_PFMBYPCTRL_VREGINCMPEN_SHIFT         0                                          /**< Shift value for EMU_VREGINCMPEN             */
#define _EMU_PFMBYPCTRL_VREGINCMPEN_MASK          0x1UL                                      /**< Bit mask for EMU_VREGINCMPEN                */
#define _EMU_PFMBYPCTRL_VREGINCMPEN_DEFAULT       0x00000000UL                               /**< Mode DEFAULT for EMU_PFMBYPCTRL             */
#define EMU_PFMBYPCTRL_VREGINCMPEN_DEFAULT        (_EMU_PFMBYPCTRL_VREGINCMPEN_DEFAULT << 0) /**< Shifted mode DEFAULT for EMU_PFMBYPCTRL     */
#define _EMU_PFMBYPCTRL_THRESSEL_SHIFT            1                                          /**< Shift value for EMU_THRESSEL                */
#define _EMU_PFMBYPCTRL_THRESSEL_MASK             0x6UL                                      /**< Bit mask for EMU_THRESSEL                   */
#define _EMU_PFMBYPCTRL_THRESSEL_DEFAULT          0x00000003UL                               /**< Mode DEFAULT for EMU_PFMBYPCTRL             */
#define EMU_PFMBYPCTRL_THRESSEL_DEFAULT           (_EMU_PFMBYPCTRL_THRESSEL_DEFAULT << 1)    /**< Shifted mode DEFAULT for EMU_PFMBYPCTRL     */
...
#define _EMU_PD1PARETCTRL_PD1PARETDIS_NORETAIN    0x00000001UL                                  /**< Mode NORETAIN for EMU_PD1PARETCTRL           */
...
#define EMU_PD1PARETCTRL_PD1PARETDIS_NORETAIN     (_EMU_PD1PARETCTRL_PD1PARETDIS_NORETAIN << 0) /**< Shifted mode NORETAIN for EMU_PD1PARETCTRL   */
...
#define _EMU_CMD_MASK                             0x00020E12UL                          /**< Mask for EMU_CMD                            */
...
#define EMU_CMD_EM01VSCALE0                       (0x1UL << 9)                          /**< Scale voltage to Vscale0                    */
#define _EMU_CMD_EM01VSCALE0_SHIFT                9                                     /**< Shift value for EMU_EM01VSCALE0             */
#define _EMU_CMD_EM01VSCALE0_MASK                 0x200UL                               /**< Bit mask for EMU_EM01VSCALE0                */
#define _EMU_CMD_EM01VSCALE0_DEFAULT              0x00000000UL                          /**< Mode DEFAULT for EMU_CMD                    */
#define EMU_CMD_EM01VSCALE0_DEFAULT               (_EMU_CMD_EM01VSCALE0_DEFAULT << 9)   /**< Shifted mode DEFAULT for EMU_CMD            */
...
#define _EMU_CTRL_EMU23VSCALE_SHIFT               8                                            /**< Shift value for EMU_EMU23VSCALE             */
#define _EMU_CTRL_EMU23VSCALE_MASK                0x300UL                                      /**< Bit mask for EMU_EMU23VSCALE                */
#define _EMU_CTRL_EMU23VSCALE_DEFAULT             0x00000002UL                                 /**< Mode DEFAULT for EMU_CTRL                   */
#define _EMU_CTRL_EMU23VSCALE_VSCALE0             0x00000000UL                                 /**< Mode VSCALE0 for EMU_CTRL                    */
#define _EMU_CTRL_EMU23VSCALE_VSCALE1             0x00000001UL                                 /**< Mode VSCALE1 for EMU_CTRL                    */
#define _EMU_CTRL_EMU23VSCALE_VSCALE2             0x00000002UL                                 /**< Mode VSCALE2 for EMU_CTRL                    */
#define EMU_CTRL_EMU23VSCALE_DEFAULT              (_EMU_CTRL_EMU23VSCALE_DEFAULT << 8)         /**< Shifted mode DEFAULT for EMU_CTRL           */
#define EMU_CTRL_EMU23VSCALE_VSCALE0              (_EMU_CTRL_EMU23VSCALE_VSCALE0 << 8)         /**< Shifted mode VSCALE0 for EMU_CTRL            */
#define EMU_CTRL_EMU23VSCALE_VSCALE1              (_EMU_CTRL_EMU23VSCALE_VSCALE1 << 8)         /**< Shifted mode VSCALE1 for EMU_CTRL            */
#define EMU_CTRL_EMU23VSCALE_VSCALE2              (_EMU_CTRL_EMU23VSCALE_VSCALE2 << 8)         /**< Shifted mode VSCALE2 for EMU_CTRL            */
...
#define _EMU_STATUS_MASK                          0xFF0054FFUL                             /**< Mask for EMU_STATUS                         */
...
#define _EMU_RSTCTRL_RESETVALUE                   0x40010407UL                                /**< Default value for EMU_RSTCTRL               */
#define _EMU_RSTCTRL_MASK                         0xC001C5CFUL                                /**< Mask for EMU_RSTCTRL                        */
...
#define _EMU_RSTCAUSE_MASK                        0x8001FFFFUL                            /**< Mask for EMU_RSTCAUSE                       */
...
#define EMU_RSTCAUSE_WDOG0                        (0x1UL << 3)                            /**< Watchdog1 Reset                             */
...
#define EMU_RSTCAUSE_WDOG1                        (0x1UL << 4)                            /**< Watchdog 2 Reset                            */
...
#define EMU_RSTCAUSE_VDDIO0BOD                    (0x1UL << 11)                           /**< LEBOD2 Reset                                */
#define _EMU_RSTCAUSE_VDDIO0BOD_SHIFT             11                                      /**< Shift value for EMU_VDDIO0BOD               */
#define _EMU_RSTCAUSE_VDDIO0BOD_MASK              0x800UL                                 /**< Bit mask for EMU_VDDIO0BOD                  */
#define _EMU_RSTCAUSE_VDDIO0BOD_DEFAULT           0x00000000UL                            /**< Mode DEFAULT for EMU_RSTCAUSE               */
#define EMU_RSTCAUSE_VDDIO0BOD_DEFAULT            (_EMU_RSTCAUSE_VDDIO0BOD_DEFAULT << 11) /**< Shifted mode DEFAULT for EMU_RSTCAUSE       */
#define EMU_RSTCAUSE_VDDIO1BOD                    (0x1UL << 12)                           /**< LEBOD3 Reset                                */
#define _EMU_RSTCAUSE_VDDIO1BOD_SHIFT             12                                      /**< Shift value for EMU_VDDIO1BOD               */
#define _EMU_RSTCAUSE_VDDIO1BOD_MASK              0x1000UL                                /**< Bit mask for EMU_VDDIO1BOD                  */
#define _EMU_RSTCAUSE_VDDIO1BOD_DEFAULT           0x00000000UL                            /**< Mode DEFAULT for EMU_RSTCAUSE               */
#define EMU_RSTCAUSE_VDDIO1BOD_DEFAULT            (_EMU_RSTCAUSE_VDDIO1BOD_DEFAULT << 12) /**< Shifted mode DEFAULT for EMU_RSTCAUSE       */
...
#define EMU_SEIF_TEMPSEIF                         (0x1UL << 29)                          /**< Temperature Interrupt flag                  */
#define _EMU_SEIF_TEMPSEIF_SHIFT                  29                                     /**< Shift value for EMU_TEMPSEIF                */
#define _EMU_SEIF_TEMPSEIF_MASK                   0x20000000UL                           /**< Bit mask for EMU_TEMPSEIF                   */
#define _EMU_SEIF_TEMPSEIF_DEFAULT                0x00000000UL                           /**< Mode DEFAULT for EMU_SEIF                   */
#define EMU_SEIF_TEMPSEIF_DEFAULT                 (_EMU_SEIF_TEMPSEIF_DEFAULT << 29)     /**< Shifted mode DEFAULT for EMU_SEIF           */
#define EMU_SEIF_TEMPLOWSEIF                      (0x1UL << 30)                          /**< Temperature Interrupt flag                  */
#define _EMU_SEIF_TEMPLOWSEIF_SHIFT               30                                     /**< Shift value for EMU_TEMPLOWSEIF             */
#define _EMU_SEIF_TEMPLOWSEIF_MASK                0x40000000UL                           /**< Bit mask for EMU_TEMPLOWSEIF                */
#define _EMU_SEIF_TEMPLOWSEIF_DEFAULT             0x00000000UL                           /**< Mode DEFAULT for EMU_SEIF                   */
#define EMU_SEIF_TEMPLOWSEIF_DEFAULT              (_EMU_SEIF_TEMPLOWSEIF_DEFAULT << 30)  /**< Shifted mode DEFAULT for EMU_SEIF           */
#define EMU_SEIF_TEMPHIGHSEIF                     (0x1UL << 31)                          /**< Temperature low Interrupt flag              */
#define _EMU_SEIF_TEMPHIGHSEIF_SHIFT              31                                     /**< Shift value for EMU_TEMPHIGHSEIF            */
#define _EMU_SEIF_TEMPHIGHSEIF_MASK               0x80000000UL                           /**< Bit mask for EMU_TEMPHIGHSEIF               */
#define _EMU_SEIF_TEMPHIGHSEIF_DEFAULT            0x00000000UL                           /**< Mode DEFAULT for EMU_SEIF                   */
#define EMU_SEIF_TEMPHIGHSEIF_DEFAULT             (_EMU_SEIF_TEMPHIGHSEIF_DEFAULT << 31) /**< Shifted mode DEFAULT for EMU_SEIF           */
...
#define EMU_SEIEN_TEMPSEIEN                       (0x1UL << 29)                            /**< Temperature Interrupt enable                */
#define _EMU_SEIEN_TEMPSEIEN_SHIFT                29                                       /**< Shift value for EMU_TEMPSEIEN               */
#define _EMU_SEIEN_TEMPSEIEN_MASK                 0x20000000UL                             /**< Bit mask for EMU_TEMPSEIEN                  */
#define _EMU_SEIEN_TEMPSEIEN_DEFAULT              0x00000000UL                             /**< Mode DEFAULT for EMU_SEIEN                  */
#define EMU_SEIEN_TEMPSEIEN_DEFAULT               (_EMU_SEIEN_TEMPSEIEN_DEFAULT << 29)     /**< Shifted mode DEFAULT for EMU_SEIEN          */
#define EMU_SEIEN_TEMPLOWSEIEN                    (0x1UL << 30)                            /**< Temperature low Interrupt enable            */
#define _EMU_SEIEN_TEMPLOWSEIEN_SHIFT             30                                       /**< Shift value for EMU_TEMPLOWSEIEN            */
#define _EMU_SEIEN_TEMPLOWSEIEN_MASK              0x40000000UL                             /**< Bit mask for EMU_TEMPLOWSEIEN               */
#define _EMU_SEIEN_TEMPLOWSEIEN_DEFAULT           0x00000000UL                             /**< Mode DEFAULT for EMU_SEIEN                  */
#define EMU_SEIEN_TEMPLOWSEIEN_DEFAULT            (_EMU_SEIEN_TEMPLOWSEIEN_DEFAULT << 30)  /**< Shifted mode DEFAULT for EMU_SEIEN          */
#define EMU_SEIEN_TEMPHIGHSEIEN                   (0x1UL << 31)                            /**< Temperature high Interrupt enable           */
#define _EMU_SEIEN_TEMPHIGHSEIEN_SHIFT            31                                       /**< Shift value for EMU_TEMPHIGHSEIEN           */
#define _EMU_SEIEN_TEMPHIGHSEIEN_MASK             0x80000000UL                             /**< Bit mask for EMU_TEMPHIGHSEIEN              */
#define _EMU_SEIEN_TEMPHIGHSEIEN_DEFAULT          0x00000000UL                             /**< Mode DEFAULT for EMU_SEIEN                  */
#define EMU_SEIEN_TEMPHIGHSEIEN_DEFAULT           (_EMU_SEIEN_TEMPHIGHSEIEN_DEFAULT << 31) /**< Shifted mode DEFAULT for EMU_SEIEN          */

/* Bit fields for EMU VSBTEMPCOMP */
#define _EMU_VSBTEMPCOMP_RESETVALUE               0x000002A8UL                                  /**< Default value for EMU_VSBTEMPCOMP           */
#define _EMU_VSBTEMPCOMP_MASK                     0x800003FDUL                                  /**< Mask for EMU_VSBTEMPCOMP                    */
#define EMU_VSBTEMPCOMP_VSBTEMPCOMPEN             (0x1UL << 0)                                  /**< VSB Temp Compensation Enable                */
#define _EMU_VSBTEMPCOMP_VSBTEMPCOMPEN_SHIFT      0                                             /**< Shift value for EMU_VSBTEMPCOMPEN           */
#define _EMU_VSBTEMPCOMP_VSBTEMPCOMPEN_MASK       0x1UL                                         /**< Bit mask for EMU_VSBTEMPCOMPEN              */
#define _EMU_VSBTEMPCOMP_VSBTEMPCOMPEN_DEFAULT    0x00000000UL                                  /**< Mode DEFAULT for EMU_VSBTEMPCOMP            */
#define EMU_VSBTEMPCOMP_VSBTEMPCOMPEN_DEFAULT     (_EMU_VSBTEMPCOMP_VSBTEMPCOMPEN_DEFAULT << 0) /**< Shifted mode DEFAULT for EMU_VSBTEMPCOMP    */
#define _EMU_VSBTEMPCOMP_R0VSB_SHIFT              2                                             /**< Shift value for EMU_R0VSB                   */
#define _EMU_VSBTEMPCOMP_R0VSB_MASK               0xCUL                                         /**< Bit mask for EMU_R0VSB                      */
#define _EMU_VSBTEMPCOMP_R0VSB_DEFAULT            0x00000002UL                                  /**< Mode DEFAULT for EMU_VSBTEMPCOMP            */
#define _EMU_VSBTEMPCOMP_R0VSB_VSB100             0x00000000UL                                  /**< Mode VSB100 for EMU_VSBTEMPCOMP              */
#define _EMU_VSBTEMPCOMP_R0VSB_VSB200             0x00000001UL                                  /**< Mode VSB200 for EMU_VSBTEMPCOMP              */
#define _EMU_VSBTEMPCOMP_R0VSB_VSB300             0x00000002UL                                  /**< Mode VSB300 for EMU_VSBTEMPCOMP              */
#define _EMU_VSBTEMPCOMP_R0VSB_VSB400             0x00000003UL                                  /**< Mode VSB400 for EMU_VSBTEMPCOMP              */
#define EMU_VSBTEMPCOMP_R0VSB_DEFAULT             (_EMU_VSBTEMPCOMP_R0VSB_DEFAULT << 2)         /**< Shifted mode DEFAULT for EMU_VSBTEMPCOMP    */
#define EMU_VSBTEMPCOMP_R0VSB_VSB100              (_EMU_VSBTEMPCOMP_R0VSB_VSB100 << 2)          /**< Shifted mode VSB100 for EMU_VSBTEMPCOMP      */
#define EMU_VSBTEMPCOMP_R0VSB_VSB200              (_EMU_VSBTEMPCOMP_R0VSB_VSB200 << 2)          /**< Shifted mode VSB200 for EMU_VSBTEMPCOMP      */
#define EMU_VSBTEMPCOMP_R0VSB_VSB300              (_EMU_VSBTEMPCOMP_R0VSB_VSB300 << 2)          /**< Shifted mode VSB300 for EMU_VSBTEMPCOMP      */
#define EMU_VSBTEMPCOMP_R0VSB_VSB400              (_EMU_VSBTEMPCOMP_R0VSB_VSB400 << 2)          /**< Shifted mode VSB400 for EMU_VSBTEMPCOMP      */
#define _EMU_VSBTEMPCOMP_R1VSB_SHIFT              4                                             /**< Shift value for EMU_R1VSB                   */
#define _EMU_VSBTEMPCOMP_R1VSB_MASK               0x30UL                                        /**< Bit mask for EMU_R1VSB                      */
#define _EMU_VSBTEMPCOMP_R1VSB_DEFAULT            0x00000002UL                                  /**< Mode DEFAULT for EMU_VSBTEMPCOMP            */
#define _EMU_VSBTEMPCOMP_R1VSB_VSB100             0x00000000UL                                  /**< Mode VSB100 for EMU_VSBTEMPCOMP              */
#define _EMU_VSBTEMPCOMP_R1VSB_VSB200             0x00000001UL                                  /**< Mode VSB200 for EMU_VSBTEMPCOMP              */
#define _EMU_VSBTEMPCOMP_R1VSB_VSB300             0x00000002UL                                  /**< Mode VSB300 for EMU_VSBTEMPCOMP              */
#define _EMU_VSBTEMPCOMP_R1VSB_VSB400             0x00000003UL                                  /**< Mode VSB400 for EMU_VSBTEMPCOMP              */
#define EMU_VSBTEMPCOMP_R1VSB_DEFAULT             (_EMU_VSBTEMPCOMP_R1VSB_DEFAULT << 4)         /**< Shifted mode DEFAULT for EMU_VSBTEMPCOMP    */
#define EMU_VSBTEMPCOMP_R1VSB_VSB100              (_EMU_VSBTEMPCOMP_R1VSB_VSB100 << 4)          /**< Shifted mode VSB100 for EMU_VSBTEMPCOMP      */
#define EMU_VSBTEMPCOMP_R1VSB_VSB200              (_EMU_VSBTEMPCOMP_R1VSB_VSB200 << 4)          /**< Shifted mode VSB200 for EMU_VSBTEMPCOMP      */
#define EMU_VSBTEMPCOMP_R1VSB_VSB300              (_EMU_VSBTEMPCOMP_R1VSB_VSB300 << 4)          /**< Shifted mode VSB300 for EMU_VSBTEMPCOMP      */
#define EMU_VSBTEMPCOMP_R1VSB_VSB400              (_EMU_VSBTEMPCOMP_R1VSB_VSB400 << 4)          /**< Shifted mode VSB400 for EMU_VSBTEMPCOMP      */
#define _EMU_VSBTEMPCOMP_R2VSB_SHIFT              6                                             /**< Shift value for EMU_R2VSB                   */
#define _EMU_VSBTEMPCOMP_R2VSB_MASK               0xC0UL                                        /**< Bit mask for EMU_R2VSB                      */
#define _EMU_VSBTEMPCOMP_R2VSB_DEFAULT            0x00000002UL                                  /**< Mode DEFAULT for EMU_VSBTEMPCOMP            */
#define _EMU_VSBTEMPCOMP_R2VSB_VSB100             0x00000000UL                                  /**< Mode VSB100 for EMU_VSBTEMPCOMP              */
#define _EMU_VSBTEMPCOMP_R2VSB_VSB200             0x00000001UL                                  /**< Mode VSB200 for EMU_VSBTEMPCOMP              */
#define _EMU_VSBTEMPCOMP_R2VSB_VSB300             0x00000002UL                                  /**< Mode VSB300 for EMU_VSBTEMPCOMP              */
#define _EMU_VSBTEMPCOMP_R2VSB_VSB400             0x00000003UL                                  /**< Mode VSB400 for EMU_VSBTEMPCOMP              */
#define EMU_VSBTEMPCOMP_R2VSB_DEFAULT             (_EMU_VSBTEMPCOMP_R2VSB_DEFAULT << 6)         /**< Shifted mode DEFAULT for EMU_VSBTEMPCOMP    */
#define EMU_VSBTEMPCOMP_R2VSB_VSB100              (_EMU_VSBTEMPCOMP_R2VSB_VSB100 << 6)          /**< Shifted mode VSB100 for EMU_VSBTEMPCOMP      */
#define EMU_VSBTEMPCOMP_R2VSB_VSB200              (_EMU_VSBTEMPCOMP_R2VSB_VSB200 << 6)          /**< Shifted mode VSB200 for EMU_VSBTEMPCOMP      */
#define EMU_VSBTEMPCOMP_R2VSB_VSB300              (_EMU_VSBTEMPCOMP_R2VSB_VSB300 << 6)          /**< Shifted mode VSB300 for EMU_VSBTEMPCOMP      */
#define EMU_VSBTEMPCOMP_R2VSB_VSB400              (_EMU_VSBTEMPCOMP_R2VSB_VSB400 << 6)          /**< Shifted mode VSB400 for EMU_VSBTEMPCOMP      */
#define _EMU_VSBTEMPCOMP_R3VSB_SHIFT              8                                             /**< Shift value for EMU_R3VSB                   */
#define _EMU_VSBTEMPCOMP_R3VSB_MASK               0x300UL                                       /**< Bit mask for EMU_R3VSB                      */
#define _EMU_VSBTEMPCOMP_R3VSB_DEFAULT            0x00000002UL                                  /**< Mode DEFAULT for EMU_VSBTEMPCOMP            */
#define _EMU_VSBTEMPCOMP_R3VSB_VSB100             0x00000000UL                                  /**< Mode VSB100 for EMU_VSBTEMPCOMP              */
#define _EMU_VSBTEMPCOMP_R3VSB_VSB200             0x00000001UL                                  /**< Mode VSB200 for EMU_VSBTEMPCOMP              */
#define _EMU_VSBTEMPCOMP_R3VSB_VSB300             0x00000002UL                                  /**< Mode VSB300 for EMU_VSBTEMPCOMP              */
#define _EMU_VSBTEMPCOMP_R3VSB_VSB400             0x00000003UL                                  /**< Mode VSB400 for EMU_VSBTEMPCOMP              */
#define EMU_VSBTEMPCOMP_R3VSB_DEFAULT             (_EMU_VSBTEMPCOMP_R3VSB_DEFAULT << 8)         /**< Shifted mode DEFAULT for EMU_VSBTEMPCOMP    */
#define EMU_VSBTEMPCOMP_R3VSB_VSB100              (_EMU_VSBTEMPCOMP_R3VSB_VSB100 << 8)          /**< Shifted mode VSB100 for EMU_VSBTEMPCOMP      */
#define EMU_VSBTEMPCOMP_R3VSB_VSB200              (_EMU_VSBTEMPCOMP_R3VSB_VSB200 << 8)          /**< Shifted mode VSB200 for EMU_VSBTEMPCOMP      */
#define EMU_VSBTEMPCOMP_R3VSB_VSB300              (_EMU_VSBTEMPCOMP_R3VSB_VSB300 << 8)          /**< Shifted mode VSB300 for EMU_VSBTEMPCOMP      */
#define EMU_VSBTEMPCOMP_R3VSB_VSB400              (_EMU_VSBTEMPCOMP_R3VSB_VSB400 << 8)          /**< Shifted mode VSB400 for EMU_VSBTEMPCOMP      */
...
/** @} End of group EFR32MG22_EMU_BitFields */
/** @} End of group EFR32MG22_EMU */
/** @} End of group Parts */
#endif /* EFR32MG22_EMU_H */

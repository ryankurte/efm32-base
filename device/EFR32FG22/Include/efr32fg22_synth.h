/**************************************************************************//**
 * @file
 * @brief EFR32FG22 SYNTH register and bit field definitions
 * @version 5.8.0
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFR32FG22_SYNTH_H
#define EFR32FG22_SYNTH_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32FG22_SYNTH SYNTH
 * @{
 * @brief EFR32FG22 SYNTH Register Declaration.
 *****************************************************************************/
...
typedef struct {
  ...
  __IOM uint32_t SEQIF;                         /**< SEQ Interrupt Flag Register                        */
  __IOM uint32_t SEQIEN;                        /**< SEQ Interrupt Enable Register                      */
  uint32_t       RESERVED5[976U];               /**< Reserved for future use*/
  ...
  __IOM uint32_t SEQIF_SET;                     /**< SEQ Interrupt Flag Register                        */
  __IOM uint32_t SEQIEN_SET;                    /**< SEQ Interrupt Enable Register                      */
  uint32_t       RESERVED11[976U];              /**< Reserved for future use*/
  ...
  __IOM uint32_t SEQIF_CLR;                     /**< SEQ Interrupt Flag Register                        */
  __IOM uint32_t SEQIEN_CLR;                    /**< SEQ Interrupt Enable Register                      */
  uint32_t       RESERVED17[976U];              /**< Reserved for future use*/
  ...
  __IOM uint32_t SEQIF_TGL;                     /**< SEQ Interrupt Flag Register                        */
  __IOM uint32_t SEQIEN_TGL;                    /**< SEQ Interrupt Enable Register                      */
} SYNTH_TypeDef;
/** @} End of group EFR32FG22_SYNTH */

/**************************************************************************//**
 * @addtogroup EFR32FG22_SYNTH
 * @{
 * @defgroup EFR32FG22_SYNTH_BitFields SYNTH Bit Fields
 * @{
 *****************************************************************************/

/* Bit fields for SYNTH IPVERSION */
#define _SYNTH_IPVERSION_RESETVALUE                   0x00000001UL                              /**< Default value for SYNTH_IPVERSION           */
...
#define _SYNTH_IPVERSION_IPVERSION_DEFAULT            0x00000001UL                              /**< Mode DEFAULT for SYNTH_IPVERSION            */
...
#define _SYNTH_CTRL_MASK                              0xD9770007UL                                      /**< Mask for SYNTH_CTRL                         */
...
#define SYNTH_CTRL_INVCLKSYNTH                        (0x1UL << 24)                                     /**< Invert clk_synth                            */
#define _SYNTH_CTRL_INVCLKSYNTH_SHIFT                 24                                                /**< Shift value for SYNTH_INVCLKSYNTH           */
#define _SYNTH_CTRL_INVCLKSYNTH_MASK                  0x1000000UL                                       /**< Bit mask for SYNTH_INVCLKSYNTH              */
#define _SYNTH_CTRL_INVCLKSYNTH_DEFAULT               0x00000000UL                                      /**< Mode DEFAULT for SYNTH_CTRL                 */
#define _SYNTH_CTRL_INVCLKSYNTH_NO                    0x00000000UL                                      /**< Mode NO for SYNTH_CTRL                       */
#define _SYNTH_CTRL_INVCLKSYNTH_YES                   0x00000001UL                                      /**< Mode YES for SYNTH_CTRL                      */
#define SYNTH_CTRL_INVCLKSYNTH_DEFAULT                (_SYNTH_CTRL_INVCLKSYNTH_DEFAULT << 24)           /**< Shifted mode DEFAULT for SYNTH_CTRL         */
#define SYNTH_CTRL_INVCLKSYNTH_NO                     (_SYNTH_CTRL_INVCLKSYNTH_NO << 24)                /**< Shifted mode NO for SYNTH_CTRL               */
#define SYNTH_CTRL_INVCLKSYNTH_YES                    (_SYNTH_CTRL_INVCLKSYNTH_YES << 24)               /**< Shifted mode YES for SYNTH_CTRL              */
...
#define SYNTH_IF_SYRDY                                (0x1UL << 2)                       /**< Synthesizer ready Interrupt Flag            */
#define _SYNTH_IF_SYRDY_SHIFT                         2                                  /**< Shift value for SYNTH_SYRDY                 */
#define _SYNTH_IF_SYRDY_MASK                          0x4UL                              /**< Bit mask for SYNTH_SYRDY                    */
#define _SYNTH_IF_SYRDY_DEFAULT                       0x00000000UL                       /**< Mode DEFAULT for SYNTH_IF                   */
#define SYNTH_IF_SYRDY_DEFAULT                        (_SYNTH_IF_SYRDY_DEFAULT << 2)     /**< Shifted mode DEFAULT for SYNTH_IF           */
...
#define SYNTH_IEN_SYRDY                               (0x1UL << 2)                        /**< CAPCALDONE Interrupt Enable                 */
#define _SYNTH_IEN_SYRDY_SHIFT                        2                                   /**< Shift value for SYNTH_SYRDY                 */
#define _SYNTH_IEN_SYRDY_MASK                         0x4UL                               /**< Bit mask for SYNTH_SYRDY                    */
#define _SYNTH_IEN_SYRDY_DEFAULT                      0x00000000UL                        /**< Mode DEFAULT for SYNTH_IEN                  */
#define SYNTH_IEN_SYRDY_DEFAULT                       (_SYNTH_IEN_SYRDY_DEFAULT << 2)     /**< Shifted mode DEFAULT for SYNTH_IEN          */
...
#define SYNTH_LOCNTCTRL_FCALRUNCLKEN                  (0x1UL << 11)                                   /**< Enable FCAL run pulse counter clock         */
#define _SYNTH_LOCNTCTRL_FCALRUNCLKEN_SHIFT           11                                              /**< Shift value for SYNTH_FCALRUNCLKEN          */
#define _SYNTH_LOCNTCTRL_FCALRUNCLKEN_MASK            0x800UL                                         /**< Bit mask for SYNTH_FCALRUNCLKEN             */
#define _SYNTH_LOCNTCTRL_FCALRUNCLKEN_DEFAULT         0x00000000UL                                    /**< Mode DEFAULT for SYNTH_LOCNTCTRL            */
#define _SYNTH_LOCNTCTRL_FCALRUNCLKEN_DISABLE         0x00000000UL                                    /**< Mode DISABLE for SYNTH_LOCNTCTRL             */
#define _SYNTH_LOCNTCTRL_FCALRUNCLKEN_ENABLE          0x00000001UL                                    /**< Mode ENABLE for SYNTH_LOCNTCTRL              */
#define SYNTH_LOCNTCTRL_FCALRUNCLKEN_DEFAULT          (_SYNTH_LOCNTCTRL_FCALRUNCLKEN_DEFAULT << 11)   /**< Shifted mode DEFAULT for SYNTH_LOCNTCTRL    */
#define SYNTH_LOCNTCTRL_FCALRUNCLKEN_DISABLE          (_SYNTH_LOCNTCTRL_FCALRUNCLKEN_DISABLE << 11)   /**< Shifted mode DISABLE for SYNTH_LOCNTCTRL     */
#define SYNTH_LOCNTCTRL_FCALRUNCLKEN_ENABLE           (_SYNTH_LOCNTCTRL_FCALRUNCLKEN_ENABLE << 11)    /**< Shifted mode ENABLE for SYNTH_LOCNTCTRL      */
...
/* Bit fields for SYNTH SEQIF */
#define _SYNTH_SEQIF_RESETVALUE                       0x00000000UL                          /**< Default value for SYNTH_SEQIF               */
#define _SYNTH_SEQIF_MASK                             0x00000237UL                          /**< Mask for SYNTH_SEQIF                        */
#define SYNTH_SEQIF_LOCKED                            (0x1UL << 0)                          /**< Synthesizer locked Interrupt Flag           */
#define _SYNTH_SEQIF_LOCKED_SHIFT                     0                                     /**< Shift value for SYNTH_LOCKED                */
#define _SYNTH_SEQIF_LOCKED_MASK                      0x1UL                                 /**< Bit mask for SYNTH_LOCKED                   */
#define _SYNTH_SEQIF_LOCKED_DEFAULT                   0x00000000UL                          /**< Mode DEFAULT for SYNTH_SEQIF                */
#define SYNTH_SEQIF_LOCKED_DEFAULT                    (_SYNTH_SEQIF_LOCKED_DEFAULT << 0)    /**< Shifted mode DEFAULT for SYNTH_SEQIF        */
#define SYNTH_SEQIF_UNLOCKED                          (0x1UL << 1)                          /**< Synthesizer unlocked Interrupt Flag         */
#define _SYNTH_SEQIF_UNLOCKED_SHIFT                   1                                     /**< Shift value for SYNTH_UNLOCKED              */
#define _SYNTH_SEQIF_UNLOCKED_MASK                    0x2UL                                 /**< Bit mask for SYNTH_UNLOCKED                 */
#define _SYNTH_SEQIF_UNLOCKED_DEFAULT                 0x00000000UL                          /**< Mode DEFAULT for SYNTH_SEQIF                */
#define SYNTH_SEQIF_UNLOCKED_DEFAULT                  (_SYNTH_SEQIF_UNLOCKED_DEFAULT << 1)  /**< Shifted mode DEFAULT for SYNTH_SEQIF        */
#define SYNTH_SEQIF_SYRDY                             (0x1UL << 2)                          /**< Synthesizer ready Interrupt Flag            */
#define _SYNTH_SEQIF_SYRDY_SHIFT                      2                                     /**< Shift value for SYNTH_SYRDY                 */
#define _SYNTH_SEQIF_SYRDY_MASK                       0x4UL                                 /**< Bit mask for SYNTH_SYRDY                    */
#define _SYNTH_SEQIF_SYRDY_DEFAULT                    0x00000000UL                          /**< Mode DEFAULT for SYNTH_SEQIF                */
#define SYNTH_SEQIF_SYRDY_DEFAULT                     (_SYNTH_SEQIF_SYRDY_DEFAULT << 2)     /**< Shifted mode DEFAULT for SYNTH_SEQIF        */
#define SYNTH_SEQIF_VCOHIGH                           (0x1UL << 4)                          /**< VCO high voltage Interrupt Flag             */
#define _SYNTH_SEQIF_VCOHIGH_SHIFT                    4                                     /**< Shift value for SYNTH_VCOHIGH               */
#define _SYNTH_SEQIF_VCOHIGH_MASK                     0x10UL                                /**< Bit mask for SYNTH_VCOHIGH                  */
#define _SYNTH_SEQIF_VCOHIGH_DEFAULT                  0x00000000UL                          /**< Mode DEFAULT for SYNTH_SEQIF                */
#define SYNTH_SEQIF_VCOHIGH_DEFAULT                   (_SYNTH_SEQIF_VCOHIGH_DEFAULT << 4)   /**< Shifted mode DEFAULT for SYNTH_SEQIF        */
#define SYNTH_SEQIF_VCOLOW                            (0x1UL << 5)                          /**< VCO low voltage Interrupt Flag              */
#define _SYNTH_SEQIF_VCOLOW_SHIFT                     5                                     /**< Shift value for SYNTH_VCOLOW                */
#define _SYNTH_SEQIF_VCOLOW_MASK                      0x20UL                                /**< Bit mask for SYNTH_VCOLOW                   */
#define _SYNTH_SEQIF_VCOLOW_DEFAULT                   0x00000000UL                          /**< Mode DEFAULT for SYNTH_SEQIF                */
#define SYNTH_SEQIF_VCOLOW_DEFAULT                    (_SYNTH_SEQIF_VCOLOW_DEFAULT << 5)    /**< Shifted mode DEFAULT for SYNTH_SEQIF        */
#define SYNTH_SEQIF_LOCNTDONE                         (0x1UL << 9)                          /**< LOCNT measurement done Interrupt Flag       */
#define _SYNTH_SEQIF_LOCNTDONE_SHIFT                  9                                     /**< Shift value for SYNTH_LOCNTDONE             */
#define _SYNTH_SEQIF_LOCNTDONE_MASK                   0x200UL                               /**< Bit mask for SYNTH_LOCNTDONE                */
#define _SYNTH_SEQIF_LOCNTDONE_DEFAULT                0x00000000UL                          /**< Mode DEFAULT for SYNTH_SEQIF                */
#define SYNTH_SEQIF_LOCNTDONE_DEFAULT                 (_SYNTH_SEQIF_LOCNTDONE_DEFAULT << 9) /**< Shifted mode DEFAULT for SYNTH_SEQIF        */

/* Bit fields for SYNTH SEQIEN */
#define _SYNTH_SEQIEN_RESETVALUE                      0x00000000UL                           /**< Default value for SYNTH_SEQIEN              */
#define _SYNTH_SEQIEN_MASK                            0x00000237UL                           /**< Mask for SYNTH_SEQIEN                       */
#define SYNTH_SEQIEN_LOCKED                           (0x1UL << 0)                           /**< LOCKED Interrupt Enable                     */
#define _SYNTH_SEQIEN_LOCKED_SHIFT                    0                                      /**< Shift value for SYNTH_LOCKED                */
#define _SYNTH_SEQIEN_LOCKED_MASK                     0x1UL                                  /**< Bit mask for SYNTH_LOCKED                   */
#define _SYNTH_SEQIEN_LOCKED_DEFAULT                  0x00000000UL                           /**< Mode DEFAULT for SYNTH_SEQIEN               */
#define SYNTH_SEQIEN_LOCKED_DEFAULT                   (_SYNTH_SEQIEN_LOCKED_DEFAULT << 0)    /**< Shifted mode DEFAULT for SYNTH_SEQIEN       */
#define SYNTH_SEQIEN_UNLOCKED                         (0x1UL << 1)                           /**< UNLOCKED Interrupt Enable                   */
#define _SYNTH_SEQIEN_UNLOCKED_SHIFT                  1                                      /**< Shift value for SYNTH_UNLOCKED              */
#define _SYNTH_SEQIEN_UNLOCKED_MASK                   0x2UL                                  /**< Bit mask for SYNTH_UNLOCKED                 */
#define _SYNTH_SEQIEN_UNLOCKED_DEFAULT                0x00000000UL                           /**< Mode DEFAULT for SYNTH_SEQIEN               */
#define SYNTH_SEQIEN_UNLOCKED_DEFAULT                 (_SYNTH_SEQIEN_UNLOCKED_DEFAULT << 1)  /**< Shifted mode DEFAULT for SYNTH_SEQIEN       */
#define SYNTH_SEQIEN_SYRDY                            (0x1UL << 2)                           /**< CAPCALDONE Interrupt Enable                 */
#define _SYNTH_SEQIEN_SYRDY_SHIFT                     2                                      /**< Shift value for SYNTH_SYRDY                 */
#define _SYNTH_SEQIEN_SYRDY_MASK                      0x4UL                                  /**< Bit mask for SYNTH_SYRDY                    */
#define _SYNTH_SEQIEN_SYRDY_DEFAULT                   0x00000000UL                           /**< Mode DEFAULT for SYNTH_SEQIEN               */
#define SYNTH_SEQIEN_SYRDY_DEFAULT                    (_SYNTH_SEQIEN_SYRDY_DEFAULT << 2)     /**< Shifted mode DEFAULT for SYNTH_SEQIEN       */
#define SYNTH_SEQIEN_VCOHIGH                          (0x1UL << 4)                           /**< VCOHIGH Interrupt Enable                    */
#define _SYNTH_SEQIEN_VCOHIGH_SHIFT                   4                                      /**< Shift value for SYNTH_VCOHIGH               */
#define _SYNTH_SEQIEN_VCOHIGH_MASK                    0x10UL                                 /**< Bit mask for SYNTH_VCOHIGH                  */
#define _SYNTH_SEQIEN_VCOHIGH_DEFAULT                 0x00000000UL                           /**< Mode DEFAULT for SYNTH_SEQIEN               */
#define SYNTH_SEQIEN_VCOHIGH_DEFAULT                  (_SYNTH_SEQIEN_VCOHIGH_DEFAULT << 4)   /**< Shifted mode DEFAULT for SYNTH_SEQIEN       */
#define SYNTH_SEQIEN_VCOLOW                           (0x1UL << 5)                           /**< VCOLOW Interrupt Enable                     */
#define _SYNTH_SEQIEN_VCOLOW_SHIFT                    5                                      /**< Shift value for SYNTH_VCOLOW                */
#define _SYNTH_SEQIEN_VCOLOW_MASK                     0x20UL                                 /**< Bit mask for SYNTH_VCOLOW                   */
#define _SYNTH_SEQIEN_VCOLOW_DEFAULT                  0x00000000UL                           /**< Mode DEFAULT for SYNTH_SEQIEN               */
#define SYNTH_SEQIEN_VCOLOW_DEFAULT                   (_SYNTH_SEQIEN_VCOLOW_DEFAULT << 5)    /**< Shifted mode DEFAULT for SYNTH_SEQIEN       */
#define SYNTH_SEQIEN_LOCNTDONE                        (0x1UL << 9)                           /**< LOCNTDONE Interrupt Enable                  */
#define _SYNTH_SEQIEN_LOCNTDONE_SHIFT                 9                                      /**< Shift value for SYNTH_LOCNTDONE             */
#define _SYNTH_SEQIEN_LOCNTDONE_MASK                  0x200UL                                /**< Bit mask for SYNTH_LOCNTDONE                */
#define _SYNTH_SEQIEN_LOCNTDONE_DEFAULT               0x00000000UL                           /**< Mode DEFAULT for SYNTH_SEQIEN               */
#define SYNTH_SEQIEN_LOCNTDONE_DEFAULT                (_SYNTH_SEQIEN_LOCNTDONE_DEFAULT << 9) /**< Shifted mode DEFAULT for SYNTH_SEQIEN       */

/** @} End of group EFR32FG22_SYNTH_BitFields */
/** @} End of group EFR32FG22_SYNTH */
/** @} End of group Parts */
#endif /* EFR32FG22_SYNTH_H */

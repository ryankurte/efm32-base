/**************************************************************************//**
 * @file
 * @brief EFR32FG22 RTCC register and bit field definitions
 * @version 5.8.0
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef EFR32FG22_RTCC_H
#define EFR32FG22_RTCC_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup EFR32FG22_RTCC RTCC
 * @{
 * @brief EFR32FG22 RTCC Register Declaration.
 *****************************************************************************/
...
/** @} End of group EFR32FG22_RTCC */

/**************************************************************************//**
 * @addtogroup EFR32FG22_RTCC
 * @{
 * @defgroup EFR32FG22_RTCC_BitFields RTCC Bit Fields
 * @{
 *****************************************************************************/
...
#define RTCC_IF_OFSEQIF                         (0x1UL << 2)                            /**< Overflow Interrupt Flag for SEQ             */
#define _RTCC_IF_OFSEQIF_SHIFT                  2                                       /**< Shift value for RTCC_OFSEQIF                */
#define _RTCC_IF_OFSEQIF_MASK                   0x4UL                                   /**< Bit mask for RTCC_OFSEQIF                   */
#define _RTCC_IF_OFSEQIF_DEFAULT                0x00000000UL                            /**< Mode DEFAULT for RTCC_IF                    */
#define RTCC_IF_OFSEQIF_DEFAULT                 (_RTCC_IF_OFSEQIF_DEFAULT << 2)         /**< Shifted mode DEFAULT for RTCC_IF            */
#define RTCC_IF_CNTTICKSEQIF                    (0x1UL << 3)                            /**< Main counter tick for SEQ                   */
#define _RTCC_IF_CNTTICKSEQIF_SHIFT             3                                       /**< Shift value for RTCC_CNTTICKSEQIF           */
#define _RTCC_IF_CNTTICKSEQIF_MASK              0x8UL                                   /**< Bit mask for RTCC_CNTTICKSEQIF              */
#define _RTCC_IF_CNTTICKSEQIF_DEFAULT           0x00000000UL                            /**< Mode DEFAULT for RTCC_IF                    */
#define RTCC_IF_CNTTICKSEQIF_DEFAULT            (_RTCC_IF_CNTTICKSEQIF_DEFAULT << 3)    /**< Shifted mode DEFAULT for RTCC_IF            */
...
#define RTCC_IF_CCSEQIF0                        (0x1UL << 5)                            /**< CC Channel n Interrupt Flag for SEQ         */
#define _RTCC_IF_CCSEQIF0_SHIFT                 5                                       /**< Shift value for RTCC_CCSEQIF0               */
#define _RTCC_IF_CCSEQIF0_MASK                  0x20UL                                  /**< Bit mask for RTCC_CCSEQIF0                  */
#define _RTCC_IF_CCSEQIF0_DEFAULT               0x00000000UL                            /**< Mode DEFAULT for RTCC_IF                    */
#define RTCC_IF_CCSEQIF0_DEFAULT                (_RTCC_IF_CCSEQIF0_DEFAULT << 5)        /**< Shifted mode DEFAULT for RTCC_IF            */
...
#define RTCC_IF_CCSEQIF1                        (0x1UL << 7)                            /**< CC Channel n Interrupt Flag for SEQ         */
#define _RTCC_IF_CCSEQIF1_SHIFT                 7                                       /**< Shift value for RTCC_CCSEQIF1               */
#define _RTCC_IF_CCSEQIF1_MASK                  0x80UL                                  /**< Bit mask for RTCC_CCSEQIF1                  */
#define _RTCC_IF_CCSEQIF1_DEFAULT               0x00000000UL                            /**< Mode DEFAULT for RTCC_IF                    */
#define RTCC_IF_CCSEQIF1_DEFAULT                (_RTCC_IF_CCSEQIF1_DEFAULT << 7)        /**< Shifted mode DEFAULT for RTCC_IF            */
...
#define RTCC_IF_CCSEQIF2                        (0x1UL << 9)                            /**< CC Channel n Interrupt Flag for SEQ         */
#define _RTCC_IF_CCSEQIF2_SHIFT                 9                                       /**< Shift value for RTCC_CCSEQIF2               */
#define _RTCC_IF_CCSEQIF2_MASK                  0x200UL                                 /**< Bit mask for RTCC_CCSEQIF2                  */
#define _RTCC_IF_CCSEQIF2_DEFAULT               0x00000000UL                            /**< Mode DEFAULT for RTCC_IF                    */
#define RTCC_IF_CCSEQIF2_DEFAULT                (_RTCC_IF_CCSEQIF2_DEFAULT << 9)        /**< Shifted mode DEFAULT for RTCC_IF            */
...
#define RTCC_IEN_OFSEQIEN                       (0x1UL << 2)                            /**< OF Interrupt Enable for SEQ                 */
#define _RTCC_IEN_OFSEQIEN_SHIFT                2                                       /**< Shift value for RTCC_OFSEQIEN               */
#define _RTCC_IEN_OFSEQIEN_MASK                 0x4UL                                   /**< Bit mask for RTCC_OFSEQIEN                  */
#define _RTCC_IEN_OFSEQIEN_DEFAULT              0x00000000UL                            /**< Mode DEFAULT for RTCC_IEN                   */
#define RTCC_IEN_OFSEQIEN_DEFAULT               (_RTCC_IEN_OFSEQIEN_DEFAULT << 2)       /**< Shifted mode DEFAULT for RTCC_IEN           */
#define RTCC_IEN_CNTTICKSEQIEN                  (0x1UL << 3)                            /**< CNTTICK Interrupt Enable for SEQ            */
#define _RTCC_IEN_CNTTICKSEQIEN_SHIFT           3                                       /**< Shift value for RTCC_CNTTICKSEQIEN          */
#define _RTCC_IEN_CNTTICKSEQIEN_MASK            0x8UL                                   /**< Bit mask for RTCC_CNTTICKSEQIEN             */
#define _RTCC_IEN_CNTTICKSEQIEN_DEFAULT         0x00000000UL                            /**< Mode DEFAULT for RTCC_IEN                   */
#define RTCC_IEN_CNTTICKSEQIEN_DEFAULT          (_RTCC_IEN_CNTTICKSEQIEN_DEFAULT << 3)  /**< Shifted mode DEFAULT for RTCC_IEN           */
...
#define RTCC_IEN_CCSEQIEN0                      (0x1UL << 5)                            /**< CC Channel n Interrupt Enable               */
#define _RTCC_IEN_CCSEQIEN0_SHIFT               5                                       /**< Shift value for RTCC_CCSEQIEN0              */
#define _RTCC_IEN_CCSEQIEN0_MASK                0x20UL                                  /**< Bit mask for RTCC_CCSEQIEN0                 */
#define _RTCC_IEN_CCSEQIEN0_DEFAULT             0x00000000UL                            /**< Mode DEFAULT for RTCC_IEN                   */
#define RTCC_IEN_CCSEQIEN0_DEFAULT              (_RTCC_IEN_CCSEQIEN0_DEFAULT << 5)      /**< Shifted mode DEFAULT for RTCC_IEN           */
...
#define RTCC_IEN_CCSEQIEN1                      (0x1UL << 7)                            /**< CC Channel n Interrupt Enable               */
#define _RTCC_IEN_CCSEQIEN1_SHIFT               7                                       /**< Shift value for RTCC_CCSEQIEN1              */
#define _RTCC_IEN_CCSEQIEN1_MASK                0x80UL                                  /**< Bit mask for RTCC_CCSEQIEN1                 */
#define _RTCC_IEN_CCSEQIEN1_DEFAULT             0x00000000UL                            /**< Mode DEFAULT for RTCC_IEN                   */
#define RTCC_IEN_CCSEQIEN1_DEFAULT              (_RTCC_IEN_CCSEQIEN1_DEFAULT << 7)      /**< Shifted mode DEFAULT for RTCC_IEN           */
...
#define RTCC_IEN_CCSEQIEN2                      (0x1UL << 9)                            /**< CC Channel n Interrupt Enable               */
#define _RTCC_IEN_CCSEQIEN2_SHIFT               9                                       /**< Shift value for RTCC_CCSEQIEN2              */
#define _RTCC_IEN_CCSEQIEN2_MASK                0x200UL                                 /**< Bit mask for RTCC_CCSEQIEN2                 */
#define _RTCC_IEN_CCSEQIEN2_DEFAULT             0x00000000UL                            /**< Mode DEFAULT for RTCC_IEN                   */
#define RTCC_IEN_CCSEQIEN2_DEFAULT              (_RTCC_IEN_CCSEQIEN2_DEFAULT << 9)      /**< Shifted mode DEFAULT for RTCC_IEN           */
...
#define RTCC_CC_CTRL_EM1PWUEN                   (0x1UL << 7)                            /**< Enable EM1P wakeup request                  */
#define _RTCC_CC_CTRL_EM1PWUEN_SHIFT            7                                       /**< Shift value for RTCC_EM1PWUEN               */
#define _RTCC_CC_CTRL_EM1PWUEN_MASK             0x80UL                                  /**< Bit mask for RTCC_EM1PWUEN                  */
#define _RTCC_CC_CTRL_EM1PWUEN_DEFAULT          0x00000000UL                            /**< Mode DEFAULT for RTCC_CC_CTRL               */
#define _RTCC_CC_CTRL_EM1PWUEN_DISABLE          0x00000000UL                            /**< Mode DISABLE for RTCC_CC_CTRL                */
#define _RTCC_CC_CTRL_EM1PWUEN_ENABLE           0x00000001UL                            /**< Mode ENABLE for RTCC_CC_CTRL                 */
#define RTCC_CC_CTRL_EM1PWUEN_DEFAULT           (_RTCC_CC_CTRL_EM1PWUEN_DEFAULT << 7)   /**< Shifted mode DEFAULT for RTCC_CC_CTRL       */
#define RTCC_CC_CTRL_EM1PWUEN_DISABLE           (_RTCC_CC_CTRL_EM1PWUEN_DISABLE << 7)   /**< Shifted mode DISABLE for RTCC_CC_CTRL        */
#define RTCC_CC_CTRL_EM1PWUEN_ENABLE            (_RTCC_CC_CTRL_EM1PWUEN_ENABLE << 7)    /**< Shifted mode ENABLE for RTCC_CC_CTRL         */
...
/** @} End of group EFR32FG22_RTCC_BitFields */
/** @} End of group EFR32FG22_RTCC */
/** @} End of group Parts */
#endif /* EFR32FG22_RTCC_H */

/**************************************************************************//**
 * @file
 * @brief BGM21 AMUXCP register and bit field definitions
 * @version 5.8.0
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef BGM21_AMUXCP_H
#define BGM21_AMUXCP_H
...
******************************************************************************/
/**************************************************************************//**
 * @defgroup BGM21_AMUXCP AMUXCP
 * @{
 * @brief BGM21 AMUXCP Register Declaration.
 *****************************************************************************/
...
/** @} End of group BGM21_AMUXCP */

/**************************************************************************//**
 * @addtogroup BGM21_AMUXCP
 * @{
 * @defgroup BGM21_AMUXCP_BitFields AMUXCP Bit Fields
 * @{
 *****************************************************************************/

/* Bit fields for AMUXCP IPVERSION */
#define _AMUXCP_IPVERSION_RESETVALUE           0x00000000UL                               /**< Default value for AMUXCP_IPVERSION          */
...
#define _AMUXCP_IPVERSION_IPVERSION_DEFAULT    0x00000000UL                               /**< Mode DEFAULT for AMUXCP_IPVERSION           */
...
#define _AMUXCP_TEST_MASK                      0x00003313UL                               /**< Mask for AMUXCP_TEST                        */
...
#define _AMUXCP_TRIM_RESETVALUE                0x77704AA1UL                               /**< Default value for AMUXCP_TRIM               */
#define _AMUXCP_TRIM_MASK                      0x77776FFFUL                               /**< Mask for AMUXCP_TRIM                        */
...
#define _AMUXCP_TRIM_BIASCTRLLO_SHIFT          16                                         /**< Shift value for AMUXCP_BIASCTRLLO           */
#define _AMUXCP_TRIM_BIASCTRLLO_MASK           0x70000UL                                  /**< Bit mask for AMUXCP_BIASCTRLLO              */
#define _AMUXCP_TRIM_BIASCTRLLO_DEFAULT        0x00000000UL                               /**< Mode DEFAULT for AMUXCP_TRIM                */
#define AMUXCP_TRIM_BIASCTRLLO_DEFAULT         (_AMUXCP_TRIM_BIASCTRLLO_DEFAULT << 16)    /**< Shifted mode DEFAULT for AMUXCP_TRIM        */
#define _AMUXCP_TRIM_BIASCTRLHI_SHIFT          20                                         /**< Shift value for AMUXCP_BIASCTRLHI           */
#define _AMUXCP_TRIM_BIASCTRLHI_MASK           0x700000UL                                 /**< Bit mask for AMUXCP_BIASCTRLHI              */
#define _AMUXCP_TRIM_BIASCTRLHI_DEFAULT        0x00000007UL                               /**< Mode DEFAULT for AMUXCP_TRIM                */
#define AMUXCP_TRIM_BIASCTRLHI_DEFAULT         (_AMUXCP_TRIM_BIASCTRLHI_DEFAULT << 20)    /**< Shifted mode DEFAULT for AMUXCP_TRIM        */
...
/** @} End of group BGM21_AMUXCP_BitFields */
/** @} End of group BGM21_AMUXCP */
/** @} End of group Parts */
#endif /* BGM21_AMUXCP_H */

...
STACKLESS void SystemInit(void)
{
  ...
  // consumption
#ifndef EM359 // All other EM359x devices have a reuduced pin set.
  SET_CMSIS_REG(GPIO->P[3].CFGL,
                _GPIO_P_CFGL_Px0_MASK,
                GPIO_P_CFGL_Px0_OUT);
  SET_CMSIS_REG(GPIO->P[3].CFGH,

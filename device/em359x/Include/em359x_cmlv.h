/**************************************************************************//**
* @file
* @brief em359x_cmlv Register and Bit Field definitions
* @version 5.8.0
******************************************************************************
* @section License
...
#ifndef EM359X_CMLV_H
#define EM359X_CMLV_H

/**************************************************************************//**
 * @defgroup EM359X_CMLV
 * @{
 * @brief EM359X_CMLV Register Declaration
 *****************************************************************************/
...
typedef struct {
  ...
  __IOM uint32_t RAMRETAIN;
} CMLV_TypeDef;              /** @} */

/**************************************************************************//**
 * @defgroup EM359X_CMLV_BitFields
 * @{
 *****************************************************************************/
...
#define _CMLV_CPUCLKSEL_MASK                          0x00000003UL
#define CMLV_CPUCLKSEL_USBSUSPCLKSELFIELD             (0x1UL << 1)
#define _CMLV_CPUCLKSEL_USBSUSPCLKSELFIELD_SHIFT      1
#define _CMLV_CPUCLKSEL_USBSUSPCLKSELFIELD_MASK       0x2UL
#define _CMLV_CPUCLKSEL_USBSUSPCLKSELFIELD_DEFAULT    0x00000000UL
#define CMLV_CPUCLKSEL_USBSUSPCLKSELFIELD_DEFAULT     (_CMLV_CPUCLKSEL_USBSUSPCLKSELFIELD_DEFAULT << 1)
...
#define _CMLV_PERIPHERALDISABLE_MASK            0x000001FFUL
#define CMLV_PERIPHERALDISABLE_USB              (0x1UL << 8)
#define _CMLV_PERIPHERALDISABLE_USB_SHIFT       8
#define _CMLV_PERIPHERALDISABLE_USB_MASK        0x100UL
#define _CMLV_PERIPHERALDISABLE_USB_DEFAULT     0x00000000UL
#define CMLV_PERIPHERALDISABLE_USB_DEFAULT      (_CMLV_PERIPHERALDISABLE_USB_DEFAULT << 8)
#define CMLV_PERIPHERALDISABLE_SC3              (0x1UL << 7)
#define _CMLV_PERIPHERALDISABLE_SC3_SHIFT       7
#define _CMLV_PERIPHERALDISABLE_SC3_MASK        0x80UL
#define _CMLV_PERIPHERALDISABLE_SC3_DEFAULT     0x00000000UL
#define CMLV_PERIPHERALDISABLE_SC3_DEFAULT      (_CMLV_PERIPHERALDISABLE_SC3_DEFAULT << 7)
#define CMLV_PERIPHERALDISABLE_SC4              (0x1UL << 6)
#define _CMLV_PERIPHERALDISABLE_SC4_SHIFT       6
#define _CMLV_PERIPHERALDISABLE_SC4_MASK        0x40UL
#define _CMLV_PERIPHERALDISABLE_SC4_DEFAULT     0x00000000UL
#define CMLV_PERIPHERALDISABLE_SC4_DEFAULT      (_CMLV_PERIPHERALDISABLE_SC4_DEFAULT << 6)
...
/* Bit fields for CMLV RAMRETAIN */
#define _CMLV_RAMRETAIN_RESETVALUE        0x0000FFFFUL
#define _CMLV_RAMRETAIN_MASK              0x0000FFFFUL
#define _CMLV_RAMRETAIN_RETAIN_SHIFT      0
#define _CMLV_RAMRETAIN_RETAIN_MASK       0xFFFFUL
#define _CMLV_RAMRETAIN_RETAIN_DEFAULT    0x0000FFFFUL
#define CMLV_RAMRETAIN_RETAIN_DEFAULT     (_CMLV_RAMRETAIN_RETAIN_DEFAULT << 0)

/** @} End of group EM359X_CMLV_BitFields */

...
/******  EM31x Peripheral Interrupt Numbers ******************************************************/
  TIM1_IRQn             = 0,  /*!< 16+0  EM31x TIM1 Interrupt */
  TIM2_IRQn             = 1,  /*!< 16+1  EM31x TIM2 Interrupt */
  MGMT_IRQn             = 2,  /*!< 16+2  EM31x MGMT Interrupt */
  BB_IRQn               = 3,  /*!< 16+3  EM31x BB Interrupt */
  SLEEPTMR_IRQn         = 4,  /*!< 16+4  EM31x SLEEPTMR Interrupt */
  SC1_IRQn              = 5,  /*!< 16+5  EM31x SC1 Interrupt */
  SC2_IRQn              = 6,  /*!< 16+6  EM31x SC2 Interrupt */
  AESCCM_IRQn           = 7,  /*!< 16+7  EM31x AESCCM Interrupt */
  MACTMR_IRQn           = 8,  /*!< 16+8  EM31x MACTMR Interrupt */
  MACTX_IRQn            = 9,  /*!< 16+9  EM31x MACTX Interrupt */
  MACRX_IRQn            = 10, /*!< 16+10 EM31x MACRX Interrupt */
  ADC_IRQn              = 11, /*!< 16+11 EM31x ADC Interrupt */
  IRQA_IRQn             = 12, /*!< 16+12 EM31x IRQA Interrupt */
  IRQB_IRQn             = 13, /*!< 16+13 EM31x IRQB Interrupt */
  IRQC_IRQn             = 14, /*!< 16+14 EM31x IRQC Interrupt */
  IRQD_IRQn             = 15, /*!< 16+15 EM31x IRQD Interrupt */
  DEBUG_IRQn            = 16, /*!< 16+16 EM31x DEBUG Interrupt */
} IRQn_Type;

/**************************************************************************//**
 * @defgroup EM317_Core EM317 Core
 * @{
...
/** @} End of group EM317_Core */

/**************************************************************************//**
* @defgroup EM317_Part EM317 Part
* @{
******************************************************************************/

/** Part family */
#define _EM31x_FAMILY  1
...
#define PART_NUMBER          "EM317" /**< Part Number */

/** Memory map for EM317 */
...
#define PORT_C_PIN_COUNT   7
#define PORT_C_PIN_MASK    0xDF // 7 6   4 3 2 1 0
#define SC_PRESENT
#define SC_COUNT           2
#define SC_MASK            0x03
...
#include "system_em31x.h"  /* System Header */

/*@}*/ /* end of group EM317_Part */

/**************************************************************************//**
 * @defgroup EM317_Peripheral_TypeDefs EM317 Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/

#include "em31x_cmhv.h"
#include "em31x_baseband.h"
#include "em31x_mac.h"
...
#include "em31x_flashctrl.h"
#include "em31x_event_adc.h"
#include "em31x_event_bb.h"
#include "em31x_event_gpio.h"
#include "em31x_event_mac.h"
#include "em31x_event_mgmt.h"
#include "em31x_event_miss.h"
#include "em31x_event_nmi.h"
#include "em31x_event_sc12.h"
#include "em31x_event_aesccm.h"
#include "em31x_event_sleeptmr.h"
#include "em31x_event_tim.h"
#include "em31x_adc.h"
#include "em31x_gpio_p.h"
#include "em31x_gpio.h"
#include "em31x_sc.h"
#include "em31x_tim.h"

/*@}*/ /* end of group EM317_Peripheral_TypeDefs */

/**************************************************************************//**
 * @defgroup EM317_Peripheral_Base EM317 Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EM317_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EM317_Peripheral_Declaration  EM317 Peripheral Declarations
 * @{
 *****************************************************************************/
...
/** @} End of group EM317_Peripheral_Declaration */

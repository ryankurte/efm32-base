/**************************************************************************//**
 * @file efr32bg1p233f256gm48.h
 * @brief CMSIS Cortex-M Peripheral Access Layer Header File
 *        for EFR32BG1P233F256GM48
 * @version 5.2.1
 ******************************************************************************
 * # License
...
#ifndef EFR32BG1P233F256GM48_H
#define EFR32BG1P233F256GM48_H
...
/**************************************************************************//**
 * @defgroup EFR32BG1P233F256GM48 EFR32BG1P233F256GM48
 * @{
 *****************************************************************************/
...
/******  EFR32BG1P Peripheral Interrupt Numbers ********************************************/
...
/**************************************************************************//**
 * @defgroup EFR32BG1P233F256GM48_Core Core
 * @{
...
/** @} End of group EFR32BG1P233F256GM48_Core */

/**************************************************************************//**
* @defgroup EFR32BG1P233F256GM48_Part Part
* @{
******************************************************************************/
...
#if !defined(EFR32BG1P233F256GM48)
#define EFR32BG1P233F256GM48    1 /**< BLUE Gecko Part */
#endif

/** Configure part number */
#define PART_NUMBER               "EFR32BG1P233F256GM48" /**< Part Number */
...
/** Flash and SRAM limits for EFR32BG1P233F256GM48 */
...
#include "system_efr32bg1p.h"   /* System Header File */

/** @} End of group EFR32BG1P233F256GM48_Part */

/**************************************************************************//**
 * @defgroup EFR32BG1P233F256GM48_Peripheral_TypeDefs Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/

#include "efr32bg1p_msc.h"
#include "efr32bg1p_emu.h"
#include "efr32bg1p_rmu.h"
#include "efr32bg1p_cmu.h"
#include "efr32bg1p_crypto.h"
#include "efr32bg1p_gpio_p.h"
#include "efr32bg1p_gpio.h"
#include "efr32bg1p_prs_ch.h"
#include "efr32bg1p_prs.h"
#include "efr32bg1p_ldma_ch.h"
#include "efr32bg1p_ldma.h"
#include "efr32bg1p_fpueh.h"
#include "efr32bg1p_gpcrc.h"
#include "efr32bg1p_timer_cc.h"
#include "efr32bg1p_timer.h"
#include "efr32bg1p_usart.h"
#include "efr32bg1p_leuart.h"
#include "efr32bg1p_letimer.h"
#include "efr32bg1p_cryotimer.h"
#include "efr32bg1p_pcnt.h"
#include "efr32bg1p_i2c.h"
#include "efr32bg1p_adc.h"
#include "efr32bg1p_acmp.h"
#include "efr32bg1p_idac.h"
#include "efr32bg1p_rtcc_cc.h"
#include "efr32bg1p_rtcc_ret.h"
#include "efr32bg1p_rtcc.h"
#include "efr32bg1p_wdog_pch.h"
#include "efr32bg1p_wdog.h"
#include "efr32bg1p_dma_descriptor.h"
#include "efr32bg1p_devinfo.h"
#include "efr32bg1p_romtable.h"

/** @} End of group EFR32BG1P233F256GM48_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup EFR32BG1P233F256GM48_Peripheral_Base Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32BG1P233F256GM48_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EFR32BG1P233F256GM48_Peripheral_Declaration Peripheral Declarations
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32BG1P233F256GM48_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup EFR32BG1P233F256GM48_Peripheral_Offsets Peripheral Offsets
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32BG1P233F256GM48_Peripheral_Offsets */


/**************************************************************************//**
 * @defgroup EFR32BG1P233F256GM48_BitFields Bit Fields
 * @{
 *****************************************************************************/

#include "efr32bg1p_prs_signals.h"
#include "efr32bg1p_dmareq.h"

/**************************************************************************//**
 * @defgroup EFR32BG1P233F256GM48_UNLOCK Unlock Codes
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32BG1P233F256GM48_UNLOCK */

/** @} End of group EFR32BG1P233F256GM48_BitFields */

#include "efr32bg1p_af_ports.h"
#include "efr32bg1p_af_pins.h"
...
/** @} End of group EFR32BG1P233F256GM48 */

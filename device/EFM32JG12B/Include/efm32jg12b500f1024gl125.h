/**************************************************************************//**
 * @file efm32jg12b500f1024gl125.h
 * @brief CMSIS Cortex-M Peripheral Access Layer Header File
 *        for EFM32JG12B500F1024GL125
 * @version 5.2.1
 ******************************************************************************
 * # License
...
#ifndef EFM32JG12B500F1024GL125_H
#define EFM32JG12B500F1024GL125_H
...
/**************************************************************************//**
 * @defgroup EFM32JG12B500F1024GL125 EFM32JG12B500F1024GL125
 * @{
 *****************************************************************************/
...
/******  EFM32JG12B Peripheral Interrupt Numbers ********************************************/
...
/**************************************************************************//**
 * @defgroup EFM32JG12B500F1024GL125_Core Core
 * @{
...
/** @} End of group EFM32JG12B500F1024GL125_Core */

/**************************************************************************//**
* @defgroup EFM32JG12B500F1024GL125_Part Part
* @{
******************************************************************************/
...
#if !defined(EFM32JG12B500F1024GL125)
#define EFM32JG12B500F1024GL125    1 /**< JADE Gecko Part */
#endif

/** Configure part number */
#define PART_NUMBER                "EFM32JG12B500F1024GL125" /**< Part Number */
...
/** Flash and SRAM limits for EFM32JG12B500F1024GL125 */
...
/** @} End of group EFM32JG12B500F1024GL125_Part */

/**************************************************************************//**
 * @defgroup EFM32JG12B500F1024GL125_Peripheral_TypeDefs Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/

#include "efm32jg12b_msc.h"
#include "efm32jg12b_emu.h"
#include "efm32jg12b_rmu.h"
#include "efm32jg12b_cmu.h"
#include "efm32jg12b_crypto.h"
#include "efm32jg12b_gpio_p.h"
#include "efm32jg12b_gpio.h"
#include "efm32jg12b_prs_ch.h"
#include "efm32jg12b_prs.h"
#include "efm32jg12b_ldma_ch.h"
#include "efm32jg12b_ldma.h"
#include "efm32jg12b_gpcrc.h"
#include "efm32jg12b_timer_cc.h"
#include "efm32jg12b_timer.h"
#include "efm32jg12b_usart.h"
#include "efm32jg12b_leuart.h"
#include "efm32jg12b_letimer.h"
#include "efm32jg12b_cryotimer.h"
#include "efm32jg12b_pcnt.h"
#include "efm32jg12b_i2c.h"
#include "efm32jg12b_adc.h"
#include "efm32jg12b_acmp.h"
#include "efm32jg12b_idac.h"
#include "efm32jg12b_vdac_opa.h"
#include "efm32jg12b_vdac.h"
#include "efm32jg12b_csen.h"
#include "efm32jg12b_lesense_st.h"
#include "efm32jg12b_lesense_buf.h"
#include "efm32jg12b_lesense_ch.h"
#include "efm32jg12b_lesense.h"
#include "efm32jg12b_rtcc_cc.h"
#include "efm32jg12b_rtcc_ret.h"
#include "efm32jg12b_rtcc.h"
#include "efm32jg12b_wdog_pch.h"
#include "efm32jg12b_wdog.h"
#include "efm32jg12b_etm.h"
#include "efm32jg12b_smu.h"
#include "efm32jg12b_trng.h"
#include "efm32jg12b_dma_descriptor.h"
#include "efm32jg12b_devinfo.h"
#include "efm32jg12b_romtable.h"

/** @} End of group EFM32JG12B500F1024GL125_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup EFM32JG12B500F1024GL125_Peripheral_Base Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFM32JG12B500F1024GL125_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EFM32JG12B500F1024GL125_Peripheral_Declaration Peripheral Declarations
 * @{
 *****************************************************************************/
...
/** @} End of group EFM32JG12B500F1024GL125_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup EFM32JG12B500F1024GL125_Peripheral_Offsets Peripheral Offsets
 * @{
 *****************************************************************************/
...
/** @} End of group EFM32JG12B500F1024GL125_Peripheral_Offsets */


/**************************************************************************//**
 * @defgroup EFM32JG12B500F1024GL125_BitFields Bit Fields
 * @{
 *****************************************************************************/

#include "efm32jg12b_prs_signals.h"
#include "efm32jg12b_dmareq.h"

/**************************************************************************//**
 * @addtogroup EFM32JG12B500F1024GL125_WTIMER
 * @{
 * @defgroup EFM32JG12B500F1024GL125_WTIMER_BitFields  WTIMER Bit Fields
 * @{
 *****************************************************************************/
...
/** @} */
/** @} End of group EFM32JG12B500F1024GL125_WTIMER */


/**************************************************************************//**
 * @defgroup EFM32JG12B500F1024GL125_UNLOCK Unlock Codes
 * @{
 *****************************************************************************/
...
/** @} End of group EFM32JG12B500F1024GL125_UNLOCK */

/** @} End of group EFM32JG12B500F1024GL125_BitFields */

#include "efm32jg12b_af_ports.h"
#include "efm32jg12b_af_pins.h"

/** @} End of group EFM32JG12B500F1024GL125 */
...
#endif
#endif /* EFM32JG12B500F1024GL125_H */

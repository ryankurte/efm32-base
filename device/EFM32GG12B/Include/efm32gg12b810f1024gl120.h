...
#ifndef EFM32GG12B810F1024GL120_H
#define EFM32GG12B810F1024GL120_H
...
/***************************************************************************//**
 * @defgroup EFM32GG12B810F1024GL120 EFM32GG12B810F1024GL120
 * @{
 ******************************************************************************/
...
/******  EFM32GG12B Peripheral Interrupt Numbers *********************************************/
  ...
  VDAC0_IRQn            = 43, /*!< 16+43 EFM32 VDAC0 Interrupt */
  CSEN_IRQn             = 44, /*!< 16+44 EFM32 CSEN Interrupt */
  LESENSE_IRQn          = 45, /*!< 16+45 EFM32 LESENSE Interrupt */
  EBI_IRQn              = 46, /*!< 16+46 EFM32 EBI Interrupt */
  ACMP2_IRQn            = 47, /*!< 16+47 EFM32 ACMP2 Interrupt */
  ADC1_IRQn             = 48, /*!< 16+48 EFM32 ADC1 Interrupt */
  LCD_IRQn              = 49, /*!< 16+49 EFM32 LCD Interrupt */
  SDIO_IRQn             = 50, /*!< 16+50 EFM32 SDIO Interrupt */
  CAN0_IRQn             = 51, /*!< 16+51 EFM32 CAN0 Interrupt */
  CAN1_IRQn             = 52, /*!< 16+52 EFM32 CAN1 Interrupt */
  USB_IRQn              = 53, /*!< 16+53 EFM32 USB Interrupt */
  RTC_IRQn              = 54, /*!< 16+54 EFM32 RTC Interrupt */
  WDOG1_IRQn            = 55, /*!< 16+55 EFM32 WDOG1 Interrupt */
  LETIMER1_IRQn         = 56, /*!< 16+56 EFM32 LETIMER1 Interrupt */
  TRNG0_IRQn            = 57, /*!< 16+57 EFM32 TRNG0 Interrupt */
  QSPI0_IRQn            = 58, /*!< 16+58 EFM32 QSPI0 Interrupt */
  PDM_IRQn              = 59, /*!< 16+59 EFM32 PDM Interrupt */
} IRQn_Type;

/***************************************************************************//**
 * @defgroup EFM32GG12B810F1024GL120_Core Core
 * @{
...
/** @} End of group EFM32GG12B810F1024GL120_Core */

/***************************************************************************//**
 * @defgroup EFM32GG12B810F1024GL120_Part Part
 * @{
 ******************************************************************************/
...
#define _SILICON_LABS_GECKO_INTERNAL_SDID        106 /**< Silicon Labs internal use only, may change any time */
#define _SILICON_LABS_GECKO_INTERNAL_SDID_106        /**< Silicon Labs internal use only, may change any time */
...
#if !defined(EFM32GG12B810F1024GL120)
#define EFM32GG12B810F1024GL120    1 /**< GIANT Gecko Part */
#endif

/** Configure part number */
#define PART_NUMBER                "EFM32GG12B810F1024GL120" /**< Part Number */

/** Memory Base addresses and limits */
#define RAM0_CODE_MEM_BASE         (0x10000000UL) /**< RAM0_CODE base address  */
#define RAM0_CODE_MEM_SIZE         (0x10000UL)    /**< RAM0_CODE available address space  */
#define RAM0_CODE_MEM_END          (0x1000FFFFUL) /**< RAM0_CODE end address  */
#define RAM0_CODE_MEM_BITS         (0x00000010UL) /**< RAM0_CODE used bits  */
#define RAM2_MEM_BASE              (0x20020000UL) /**< RAM2 base address  */
#define RAM2_MEM_SIZE              (0x10000UL)    /**< RAM2 available address space  */
#define RAM2_MEM_END               (0x2002FFFFUL) /**< RAM2 end address  */
#define RAM2_MEM_BITS              (0x00000010UL) /**< RAM2 used bits  */
#define RAM1_MEM_BASE              (0x20010000UL) /**< RAM1 base address  */
#define RAM1_MEM_SIZE              (0x10000UL)    /**< RAM1 available address space  */
#define RAM1_MEM_END               (0x2001FFFFUL) /**< RAM1 end address  */
#define RAM1_MEM_BITS              (0x00000010UL) /**< RAM1 used bits  */
...
#define RAM1_CODE_MEM_BASE         (0x10010000UL) /**< RAM1_CODE base address  */
#define RAM1_CODE_MEM_SIZE         (0x10000UL)    /**< RAM1_CODE available address space  */
#define RAM1_CODE_MEM_END          (0x1001FFFFUL) /**< RAM1_CODE end address  */
#define RAM1_CODE_MEM_BITS         (0x00000010UL) /**< RAM1_CODE used bits  */
...
#define RAM2_CODE_MEM_BASE         (0x10020000UL) /**< RAM2_CODE base address  */
#define RAM2_CODE_MEM_SIZE         (0x10000UL)    /**< RAM2_CODE available address space  */
#define RAM2_CODE_MEM_END          (0x1002FFFFUL) /**< RAM2_CODE end address  */
#define RAM2_CODE_MEM_BITS         (0x00000010UL) /**< RAM2_CODE used bits  */
...
#define RAM0_MEM_SIZE              (0x10000UL)    /**< RAM0 available address space  */
#define RAM0_MEM_END               (0x2000FFFFUL) /**< RAM0 end address  */
#define RAM0_MEM_BITS              (0x00000010UL) /**< RAM0 used bits  */
...
#define RAM_MEM_SIZE               (0x30000UL)    /**< RAM available address space  */
#define RAM_MEM_END                (0x2002FFFFUL) /**< RAM end address  */
#define RAM_MEM_BITS               (0x00000012UL) /**< RAM used bits  */
...
/** Flash and SRAM limits for EFM32GG12B810F1024GL120 */
...
#define PRS_CHAN_COUNT             16             /**< Number of PRS channels */
#define DMA_CHAN_COUNT             12             /**< Number of DMA channels */
#define EXT_IRQ_COUNT              60             /**< Number of External (NVIC) interrupts */

/** AF channels connect the different on-chip peripherals with the af-mux */
#define AFCHAN_MAX                 265U
/** AF channel maximum location number */
#define AFCHANLOC_MAX              8U
/** Analog AF channels */
#define AFACHAN_MAX                172U
...
#define USART_COUNT           5 /**< 5 USARTs available  */
...
#define PDM_COUNT             1 /**< 1 PDM available */
...
#include "system_efm32gg12b.h"  /* System Header File */

/** @} End of group EFM32GG12B810F1024GL120_Part */

/***************************************************************************//**
 * @defgroup EFM32GG12B810F1024GL120_Peripheral_TypeDefs Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 ******************************************************************************/

#include "efm32gg12b_msc.h"
#include "efm32gg12b_emu.h"
#include "efm32gg12b_rmu.h"
#include "efm32gg12b_cmu.h"
#include "efm32gg12b_crypto.h"
#include "efm32gg12b_lesense_st.h"
#include "efm32gg12b_lesense_buf.h"
#include "efm32gg12b_lesense_ch.h"
#include "efm32gg12b_lesense.h"
#include "efm32gg12b_ebi.h"
#include "efm32gg12b_sdio.h"
#include "efm32gg12b_pdm.h"
#include "efm32gg12b_gpio_p.h"
#include "efm32gg12b_gpio.h"
#include "efm32gg12b_prs_ch.h"
#include "efm32gg12b_prs.h"
#include "efm32gg12b_ldma_ch.h"
#include "efm32gg12b_ldma.h"
#include "efm32gg12b_fpueh.h"
#include "efm32gg12b_gpcrc.h"
#include "efm32gg12b_can_mir.h"
#include "efm32gg12b_can.h"
#include "efm32gg12b_timer_cc.h"
#include "efm32gg12b_timer.h"
#include "efm32gg12b_usart.h"
#include "efm32gg12b_qspi.h"
#include "efm32gg12b_leuart.h"
#include "efm32gg12b_letimer.h"
#include "efm32gg12b_cryotimer.h"
#include "efm32gg12b_pcnt.h"
#include "efm32gg12b_i2c.h"
#include "efm32gg12b_adc.h"
#include "efm32gg12b_acmp.h"
#include "efm32gg12b_vdac_opa.h"
#include "efm32gg12b_vdac.h"
#include "efm32gg12b_usb_hc.h"
#include "efm32gg12b_usb_diep.h"
#include "efm32gg12b_usb_doep.h"
#include "efm32gg12b_usb.h"
#include "efm32gg12b_idac.h"
#include "efm32gg12b_csen.h"
#include "efm32gg12b_lcd.h"
#include "efm32gg12b_rtc_comp.h"
#include "efm32gg12b_rtc.h"
#include "efm32gg12b_rtcc_cc.h"
#include "efm32gg12b_rtcc_ret.h"
#include "efm32gg12b_rtcc.h"
#include "efm32gg12b_wdog_pch.h"
#include "efm32gg12b_wdog.h"
#include "efm32gg12b_etm.h"
#include "efm32gg12b_smu.h"
#include "efm32gg12b_trng.h"
#include "efm32gg12b_dma_descriptor.h"
#include "efm32gg12b_devinfo.h"
#include "efm32gg12b_romtable.h"

/** @} End of group EFM32GG12B810F1024GL120_Peripheral_TypeDefs  */

/***************************************************************************//**
 * @defgroup EFM32GG12B810F1024GL120_Peripheral_Base Peripheral Memory Map
 * @{
 ******************************************************************************/
...
#define PDM_BASE          (0x40028000UL) /**< PDM base address  */
...
/** @} End of group EFM32GG12B810F1024GL120_Peripheral_Base */

/***************************************************************************//**
 * @defgroup EFM32GG12B810F1024GL120_Peripheral_Declaration Peripheral Declarations
 * @{
 ******************************************************************************/
...
/** @} End of group EFM32GG12B810F1024GL120_Peripheral_Declaration */

/***************************************************************************//**
 * @defgroup EFM32GG12B810F1024GL120_Peripheral_Offsets Peripheral Offsets
 * @{
 ******************************************************************************/
...
/** @} End of group EFM32GG12B810F1024GL120_Peripheral_Offsets */

/***************************************************************************//**
 * @defgroup EFM32GG12B810F1024GL120_BitFields Bit Fields
 * @{
 ******************************************************************************/

#include "efm32gg12b_prs_signals.h"
#include "efm32gg12b_dmareq.h"

/***************************************************************************//**
 * @addtogroup EFM32GG12B810F1024GL120_WTIMER
 * @{
 * @defgroup EFM32GG12B810F1024GL120_WTIMER_BitFields  WTIMER Bit Fields
 * @{
 ******************************************************************************/
...
/** @} */
/** @} End of group EFM32GG12B810F1024GL120_WTIMER */

#include "efm32gg12b_uart.h"

/***************************************************************************//**
 * @defgroup EFM32GG12B810F1024GL120_UNLOCK Unlock Codes
 * @{
 ******************************************************************************/
...
/** @} End of group EFM32GG12B810F1024GL120_UNLOCK */

/** @} End of group EFM32GG12B810F1024GL120_BitFields */

#include "efm32gg12b_af_ports.h"
#include "efm32gg12b_af_pins.h"

/** @} End of group EFM32GG12B810F1024GL120 */
...
#endif
#endif /* EFM32GG12B810F1024GL120_H */

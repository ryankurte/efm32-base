/***************************************************************************//**
 * @file
 * @brief EFM32GG12B_PRS_SIGNALS register and bit field definitions
 * @version 5.8.0
 *******************************************************************************
 * # License
 ...
 * @{
 * @addtogroup EFM32GG12B_PRS_Signals PRS Signals
 * @{
...
#define PRS_ADC1_SINGLE             ((29 << 8) + 0)  /**< PRS ADC single conversion done */
#define PRS_ADC1_SCAN               ((29 << 8) + 1)  /**< PRS ADC scan conversion done */
...
#define PRS_PDM_DSRPULSE            ((121 << 8) + 0) /**< PRS PDM DSR pulse */

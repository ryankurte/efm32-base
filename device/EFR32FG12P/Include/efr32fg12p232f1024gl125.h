/**************************************************************************//**
 * @file efr32fg12p232f1024gl125.h
 * @brief CMSIS Cortex-M Peripheral Access Layer Header File
 *        for EFR32FG12P232F1024GL125
 * @version 5.2.1
 ******************************************************************************
 * # License
...
#ifndef EFR32FG12P232F1024GL125_H
#define EFR32FG12P232F1024GL125_H
...
/**************************************************************************//**
 * @defgroup EFR32FG12P232F1024GL125 EFR32FG12P232F1024GL125
 * @{
 *****************************************************************************/
...
/******  EFR32FG12P Peripheral Interrupt Numbers ********************************************/
...
/**************************************************************************//**
 * @defgroup EFR32FG12P232F1024GL125_Core Core
 * @{
...
/** @} End of group EFR32FG12P232F1024GL125_Core */

/**************************************************************************//**
* @defgroup EFR32FG12P232F1024GL125_Part Part
* @{
******************************************************************************/
...
#if !defined(EFR32FG12P232F1024GL125)
#define EFR32FG12P232F1024GL125    1 /**< FLEX Gecko Part */
#endif

/** Configure part number */
#define PART_NUMBER                "EFR32FG12P232F1024GL125" /**< Part Number */
...
/** Flash and SRAM limits for EFR32FG12P232F1024GL125 */
...
#include "system_efr32fg12p.h"  /* System Header File */

/** @} End of group EFR32FG12P232F1024GL125_Part */

/**************************************************************************//**
 * @defgroup EFR32FG12P232F1024GL125_Peripheral_TypeDefs Peripheral TypeDefs
 * @{
 * @brief Device Specific Peripheral Register Structures
 *****************************************************************************/

#include "efr32fg12p_msc.h"
#include "efr32fg12p_emu.h"
#include "efr32fg12p_rmu.h"
#include "efr32fg12p_cmu.h"
#include "efr32fg12p_crypto.h"
#include "efr32fg12p_gpio_p.h"
#include "efr32fg12p_gpio.h"
#include "efr32fg12p_prs_ch.h"
#include "efr32fg12p_prs.h"
#include "efr32fg12p_ldma_ch.h"
#include "efr32fg12p_ldma.h"
#include "efr32fg12p_fpueh.h"
#include "efr32fg12p_gpcrc.h"
#include "efr32fg12p_timer_cc.h"
#include "efr32fg12p_timer.h"
#include "efr32fg12p_usart.h"
#include "efr32fg12p_leuart.h"
#include "efr32fg12p_letimer.h"
#include "efr32fg12p_cryotimer.h"
#include "efr32fg12p_pcnt.h"
#include "efr32fg12p_i2c.h"
#include "efr32fg12p_adc.h"
#include "efr32fg12p_acmp.h"
#include "efr32fg12p_idac.h"
#include "efr32fg12p_vdac_opa.h"
#include "efr32fg12p_vdac.h"
#include "efr32fg12p_csen.h"
#include "efr32fg12p_lesense_st.h"
#include "efr32fg12p_lesense_buf.h"
#include "efr32fg12p_lesense_ch.h"
#include "efr32fg12p_lesense.h"
#include "efr32fg12p_rtcc_cc.h"
#include "efr32fg12p_rtcc_ret.h"
#include "efr32fg12p_rtcc.h"
#include "efr32fg12p_wdog_pch.h"
#include "efr32fg12p_wdog.h"
#include "efr32fg12p_etm.h"
#include "efr32fg12p_smu.h"
#include "efr32fg12p_trng.h"
#include "efr32fg12p_dma_descriptor.h"
#include "efr32fg12p_devinfo.h"
#include "efr32fg12p_romtable.h"

/** @} End of group EFR32FG12P232F1024GL125_Peripheral_TypeDefs  */

/**************************************************************************//**
 * @defgroup EFR32FG12P232F1024GL125_Peripheral_Base Peripheral Memory Map
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32FG12P232F1024GL125_Peripheral_Base */

/**************************************************************************//**
 * @defgroup EFR32FG12P232F1024GL125_Peripheral_Declaration Peripheral Declarations
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32FG12P232F1024GL125_Peripheral_Declaration */

/**************************************************************************//**
 * @defgroup EFR32FG12P232F1024GL125_Peripheral_Offsets Peripheral Offsets
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32FG12P232F1024GL125_Peripheral_Offsets */


/**************************************************************************//**
 * @defgroup EFR32FG12P232F1024GL125_BitFields Bit Fields
 * @{
 *****************************************************************************/

#include "efr32fg12p_prs_signals.h"
#include "efr32fg12p_dmareq.h"

/**************************************************************************//**
 * @addtogroup EFR32FG12P232F1024GL125_WTIMER
 * @{
 * @defgroup EFR32FG12P232F1024GL125_WTIMER_BitFields  WTIMER Bit Fields
 * @{
 *****************************************************************************/
...
/** @} */
/** @} End of group EFR32FG12P232F1024GL125_WTIMER */


/**************************************************************************//**
 * @defgroup EFR32FG12P232F1024GL125_UNLOCK Unlock Codes
 * @{
 *****************************************************************************/
...
/** @} End of group EFR32FG12P232F1024GL125_UNLOCK */

/** @} End of group EFR32FG12P232F1024GL125_BitFields */

#include "efr32fg12p_af_ports.h"
#include "efr32fg12p_af_pins.h"

/** @} End of group EFR32FG12P232F1024GL125 */
...
#endif
#endif /* EFR32FG12P232F1024GL125_H */

...
struct ezradio_reply_EZCONFIG_CHECK_map {
        uint8_t  RESULT;
};
...
typedef union ezradio_cmd_reply_union {
        ...
        struct ezradio_reply_EZCONFIG_CHECK_map                           EZCONFIG_CHECK;
} ezradio_cmd_reply_t;
...
#define EZRADIO_CMD_REPLY_COUNT_GET_ADC_READING 4
...
#define EZRADIO_CMD_ID_EZCONFIG_CHECK 0x19
/* EZCONFIG_CHECK ARGS */
#define EZRADIO_CMD_ARG_COUNT_EZCONFIG_CHECK 2
/* EZCONFIG_CHECK REPLY */
#define EZRADIO_CMD_REPLY_COUNT_EZCONFIG_CHECK 1
        /* macros for entire EZCONFIG_CHECK access of type uint8_t */
        #define EZRADIO_CMD_EZCONFIG_CHECK_ARG_CHECKSUM_TYPE uint16_t
        #define EZRADIO_CMD_EZCONFIG_CHECK_ARG_CHECKSUM_SIZE 16
        #define EZRADIO_CMD_EZCONFIG_CHECK_ARG_CHECKSUM_MASK 0xffff
        #define EZRADIO_CMD_EZCONFIG_CHECK_ARG_CHECKSUM_MSB 15
        #define EZRADIO_CMD_EZCONFIG_CHECK_ARG_CHECKSUM_LSB 0
        #define EZRADIO_CMD_EZCONFIG_CHECK_ARG_CHECKSUM_INDEX 1
        /* macros for entire REPLY CMD_ERR_STATUS access of type uint8_t */
        #define EZRADIO_CMD_EZCONFIG_CHECK_REP_RESULT_TYPE uint8_t
        #define EZRADIO_CMD_EZCONFIG_CHECK_REP_RESULT_SIZE 8
        #define EZRADIO_CMD_EZCONFIG_CHECK_REP_RESULT_MASK 0xff
        #define EZRADIO_CMD_EZCONFIG_CHECK_REP_RESULT_MSB 7
        #define EZRADIO_CMD_EZCONFIG_CHECK_REP_RESULT_LSB 0
        #define EZRADIO_CMD_EZCONFIG_CHECK_REP_RESULT_INDEX 3
        /* macros for field CMD_ERR_STATUS access */
        #define EZRADIO_CMD_EZCONFIG_CHECK_REP_RESULT_RESULT_TYPE enum
        #define EZRADIO_CMD_EZCONFIG_CHECK_REP_RESULT_RESULT_SIZE 8
        #define EZRADIO_CMD_EZCONFIG_CHECK_REP_RESULT_RESULT_MASK 0xff
        #define EZRADIO_CMD_EZCONFIG_CHECK_REP_RESULT_RESULT_MSB 7
        #define EZRADIO_CMD_EZCONFIG_CHECK_REP_RESULT_RESULT_LSB 0
        #define EZRADIO_CMD_EZCONFIG_CHECK_REP_RESULT_RESULT_INDEX 3
        #define EZRADIO_CMD_EZCONFIG_CHECK_REP_RESULT_RESULT_ENUM_VALID 0
        #define EZRADIO_CMD_EZCONFIG_CHECK_REP_RESULT_RESULT_ENUM_BAD_CHECKSUM 1
        #define EZRADIO_CMD_EZCONFIG_CHECK_REP_RESULT_RESULT_ENUM_INVALID_STATE 2

#define EZRADIO_CMD_ID_EZCONFIG_ARRAY_WRITE 0x66
/* ZCONFIG_ARRAY_WRITE ARGS */
#define EZRADIO_CMD_ARG_COUNT_EZCONFIG_ARRAY_WRITE 3
        /* macros for entire ARG DATA access of type uint8_t */
        #define EZRADIO_CMD_EZCONFIG_ARRAY_WRITE_ARG_DATA_TYPE uint8_t
        #define EZRADIO_CMD_EZCONFIG_ARRAY_WRITE_ARG_DATA_SIZE 8
        #define EZRADIO_CMD_EZCONFIG_ARRAY_WRITE_ARG_DATA_MASK 0xff
        #define EZRADIO_CMD_EZCONFIG_ARRAY_WRITE_ARG_DATA_MSB 7
        #define EZRADIO_CMD_EZCONFIG_ARRAY_WRITE_ARG_DATA_LSB 0
        #define EZRADIO_CMD_EZCONFIG_ARRAY_WRITE_ARG_DATA_INDEX 1
        #define EZRADIO_CMD_EZCONFIG_ARRAY_WRITE_ARG_DATA_ARRAY_LEN 2
        #define EZRADIO_CMD_EZCONFIG_ARRAY_WRITE_ARG_DATA_value(i) (((cmd.arg.WRITE_TX_FIFO.DATA[(i)])))
        /* macros for field DATA access */
        #define EZRADIO_CMD_EZCONFIG_ARRAY_WRITE_ARG_DATA_DATA_TYPE uint8_t
        #define EZRADIO_CMD_EZCONFIG_ARRAY_WRITE_ARG_DATA_DATA_SIZE 8
        #define EZRADIO_CMD_EZCONFIG_ARRAY_WRITE_ARG_DATA_DATA_MASK 0xff
        #define EZRADIO_CMD_EZCONFIG_ARRAY_WRITE_ARG_DATA_DATA_MSB 7
        #define EZRADIO_CMD_EZCONFIG_ARRAY_WRITE_ARG_DATA_DATA_LSB 0
        #define EZRADIO_CMD_EZCONFIG_ARRAY_WRITE_ARG_DATA_DATA_INDEX 1
        #define EZRADIO_CMD_EZCONFIG_ARRAY_WRITE_ARG_DATA_DATA_value(i) (((cmd.arg.WRITE_TX_FIFO.DATA[(i)] & 0xff)))

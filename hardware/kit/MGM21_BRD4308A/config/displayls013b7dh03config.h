/***************************************************************************//**
 * @file
 * @brief Board specific configuration for the display driver for
...
#define LCD_PORT_SCLK             (gpioPortC)  /* EFM_DISP_SCLK on PC2 */
#define LCD_PIN_SCLK              (2)
#define LCD_PORT_SI               (gpioPortC)  /* EFM_DISP_MOSI on PC0 */
#define LCD_PIN_SI                (0)
#define LCD_PORT_SCS              (gpioPortC)  /* EFM_DISP_CS on PC3 */
#define LCD_PIN_SCS               (3)
#define LCD_PORT_EXTCOMIN         (gpioPortA)  /* EFM_DISP_COM on PA0 */
#define LCD_PIN_EXTCOMIN          (0)
#define LCD_PORT_DISP_PWR         (gpioPortD)  /* EFM_DISP_ENABLE on PD4 */

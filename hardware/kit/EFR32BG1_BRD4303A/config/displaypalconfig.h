...
/*
 * PAL SPI / USART configuration for the SLWSTK6102A.
 ...
 */
#define PAL_SPI_BAUDRATE       (3500000) /* Max baudrate on EFR32XG1. */

/*
 * On the SLWSTK6102A, we can toggle some GPIO pins with hw only,

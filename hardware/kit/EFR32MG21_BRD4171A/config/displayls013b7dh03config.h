...
#define LCD_PORT_SCLK             (gpioPortD)
#define LCD_PIN_SCLK              (2)
#define LCD_PORT_SI               (gpioPortD)
#define LCD_PIN_SI                (0)
#define LCD_PORT_SCS              (gpioPortD)
#define LCD_PIN_SCS               (4)
#define LCD_PORT_EXTCOMIN         (gpioPortB)
#define LCD_PIN_EXTCOMIN          (0)
#define LCD_PORT_DISP_SEL         (gpioPortB)
#define LCD_PIN_DISP_SEL          (1)

...
/*
 * PAL SPI / USART configuration for the SLWSTK6061A.
 ...
 */
#define PAL_SPI_BAUDRATE       (3500000) /* Max baudrate on EFR32FG1. */

/*
 * On the SLWSTK6061A, we can toggle some GPIO pins with hw only,

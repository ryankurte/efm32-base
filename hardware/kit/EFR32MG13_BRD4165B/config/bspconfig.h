...
#define BSP_HFXO_CTUNE          341U

#if defined(EMU_DCDCINIT_WSTK_DEFAULT)
#warning "The BRD4165B is not wired for DCDC. "
"Application must call EMU_DCDCPowerOff() instead of EMU_DCDCInit()"
#endif

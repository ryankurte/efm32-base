...
#define CS0_I2C_INT_PORT          gpioPortE
#define CS0_I2C_INT_PIN           11
#define CS0_I2C_SDA_PORT          gpioPortD
#define CS0_I2C_SDA_PIN           6
#define CS0_I2C_SCL_PORT          gpioPortD
#define CS0_I2C_SCL_PIN           7
...
#define CS0_0_PORT                gpioPortE
#define CS0_0_PIN                 11
#define CS0_1_PORT                gpioPortE
#define CS0_1_PIN                 13

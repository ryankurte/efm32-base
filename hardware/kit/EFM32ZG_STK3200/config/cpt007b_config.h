...
#define CS0_I2C_LOC               6
#define CS0_I2C_INT_PORT          gpioPortD
#define CS0_I2C_INT_PIN           6
#define CS0_I2C_SDA_PORT          gpioPortE
#define CS0_I2C_SDA_PIN           12
#define CS0_I2C_SCL_PORT          gpioPortE
#define CS0_I2C_SCL_PIN           13
...
#define CS0_1_PIN                 14
#define CS0_2_PORT                gpioPortE
#define CS0_2_PIN                 12
#define CS0_3_PORT                gpioPortE
#define CS0_3_PIN                 13
#define CS0_4_PORT                gpioPortC
#define CS0_4_PIN                 1
#define CS0_5_PORT                gpioPortC
#define CS0_5_PIN                 2
#define CS0_6_PORT                gpioPortA
#define CS0_6_PIN                 0

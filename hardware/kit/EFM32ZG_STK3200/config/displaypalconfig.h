...
#define PAL_SPI_USART_LOCATION    (USART_ROUTE_LOCATION_LOC3)
#define PAL_SPI_USART_DMAREQ_TXBL (DMAREQ_USART1_TXBL)
...
/*
 * On the EFM32ZG_STK3200, we can toggle some GPIO pins with hw only,

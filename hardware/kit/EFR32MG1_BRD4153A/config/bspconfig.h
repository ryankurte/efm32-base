...
#define BSP_BCC_CTS_LOCATION  _USART_ROUTELOC1_CTSLOC_LOC30
#define BSP_BCC_RTS_LOCATION  _USART_ROUTELOC1_CTSLOC_LOC30
#define BSP_BCC_CTSPORT       gpioPortA
#define BSP_BCC_CTSPIN        2
#define BSP_BCC_RTSPORT       gpioPortA
#define BSP_BCC_RTSPIN        3
...
#define BSP_HFXO_PRESENT 1
#define BSP_HFXO_FREQ 38400000UL
